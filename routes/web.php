...
Route::get('/tmu/vision-mission-and-objectives', [TmuController::class, 'ctld_about'])->name('ctld.about');
Route::get('/tmu/ctld-usps', [TmuController::class, 'ctld_benefits'])->name('ctld.benefits');
Route::get('/tmu/why-ctld-matters', [TmuController::class, 'ctld_aims_and_objectives'])->name('ctld.aims.and.objectives');
...
Route::get('/tmu/iqac-cell/iqac-activities', [TmuController::class, 'iqac_activities'])->name('iqac.iqac.activities');
...
Route::get('/tmu/darpan', [TmuController::class, 'tmu_darpan'])->name('tmu.darpan');
...
Route::get('/student-club/gallery', [ClubsController::class, 'student_club_gallery'])->name('student.club.gallery');
...
Route::get('/visual-story/{id}', [TmuController::class, 'visual_story_show'])->name('visual.story');
