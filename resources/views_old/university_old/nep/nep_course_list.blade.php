    ...
    <div class="container">
        ...
        <div class="table-responisve">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>Ability Enhancement Course-1</td>
                        <td rowspan="4"> AEC</td>
                        <td> English Communication -I</td>
                        <td> I</td>
                    </tr>
                    <tr>
                        <td>Ability Enhancement Course-2</td>
                        <td> English Communication -II</td>
                        <td> II</td>
                    </tr>
                    <tr>
                        <td>Ability Enhancement Course-3</td>
                        <td> Content Writing & Editing</td>
                        <td> III</td>
                    </tr>
                    <tr>
                        <td>Ability Enhancement Course-4</td>
                        <td> Communication Tools in Digital Era</td>
                        <td> IV</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Multi-Disciplinary Course- 3</td>
                        <td>Self-Development & Life Readiness</td>
                        <td>II</td>
                    </tr>
                    <tr>
                        <td>Multi-Disciplinary Course- 4</td>
                        <td>Basics of Aptitude and Design Thinking</td>
                        <td>II</td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="table-responsive mb-4">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>Value Added Course-1</td>
                        <td rowspan="5"> VAC</td>
                        <td> Indian Knowledge System</td>
                        <td rowspan="2"> I</td>
                    </tr>
                    <tr>
                        <td>Value Added Course-2</td>
                        <td>Environmental Sciences </td>
                    </tr>
                    <tr>
                        <td>Value Added Course-3</td>
                        <td>Digital Technology in Education</td>
                        <td rowspan="2"> II</td>
                    </tr>
                    <tr>
                        <td>Value Added Course-4</td>
                        <td>Health & Wellness </td>
                    </tr>
                    <tr>
                        <td>Value Added Course-5</td>
