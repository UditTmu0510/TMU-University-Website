      ...
      <div class="row">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-4">
              <a class="grid-item" href="{{asset('assets/img/university/about-img.webp')}}" data-lightbox="gallery-item"><img src="{{asset('images/about-img.jpg')}}" class="d-block mx-auto" alt="Gallery Thumb 1"></a>
            </div>
            ...
            <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
              <div class="col-md-4 col-sm-12 mb-md-0">
                <a href="#" class="entry-image mb-0 h-100">
                  <img src="{{asset('assets/img/university/campus_facilities/Water_Recycling_System.webp')}}" alt="Water Recycling System at TMU" class="rounded-2 h-100 object-cover">
        ...
        <div class="carousel-item">
          <article class="entry event col-12 mb-4">
            ...
            <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
              <div class="col-md-4 col-sm-12 mb-md-0">
                <a href="#" class="entry-image mb-0 h-100">
                  <img src="{{asset('assets/img/university/campus_facilities//solar_energy.webp')}}" alt="Solar energy at TMU" class="rounded-2 h-100 object-cover">
                  <div class="bg-overlay">
                  </div>
                </a>
              </div>
        ...
        <div class="carousel-item">
          <article class="entry event col-12 mb-4">
            ...
            <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
              <div class="col-md-4 col-sm-12 mb-md-0">
                <a href="#" class="entry-image mb-0 h-100">
                  <img src="{{asset('assets/img/university/campus_facilities/eco_green_campus.webp')}}" alt="Eco green campus at TMU" class="rounded-2 h-100 object-cover">
                  <div class="bg-overlay">
                  </div>
                </a>
              </div>
    ...
    <div class="container d-none d-md-block">
      <div class="row justify-content-center">
        <div class="col-md-3 text-center">
          <a href="">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Hospital_02.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Hostel.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Faculty_Residences.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Indoor.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Gym.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/Outdoor.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/CCTV.webp')}}" alt="Image">
          </a>
        ...
        <div class="col-md-3 text-center">
          <a href="#">
            <img class="img-fluid mb-2" src="{{asset('assets/img/university/campus_facilities/E_lobby.webp')}}" alt="Image">
          </a>
              ...
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-12 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Hospital_02.JPG')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Hostel.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Faculty_Residences.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Indoor.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Gym.JPG')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/Outdoor.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/CCTV.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
            ...
            <div class="carousel-item">
              <article class="entry event col-12 col-md-6 mb-4">
                ...
                <div class="grid-inner row g-0 p-3 border-0 rounded-5 shadow-sm h-shadow all-ts h-translate-y-sm">
                  <div class="col-md-4 col-sm-12 mb-md-0">
                    <a href="#" class="entry-image mb-0 h-100">
                      <img src="{{asset('images/campus_facilities/E_lobby.jpg')}}" alt="Inventore voluptates velit totam ipsa tenetur" class="rounded-2 h-100 object-cover">
                      <div class="bg-overlay">
                      </div>
                    </a>
                  </div>
