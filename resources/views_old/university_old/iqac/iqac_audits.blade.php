					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<tr>
								<td>1.</td>
								<td>Green Audit</td>
								<td class="text-center"><a href="https://www.tmu.ac.in/pdf/environment_and_energy_audit/green-audit-report.pdf"><i class="fa-solid fa-file-pdf"></i></a></td>
							</tr>
							<tr>
								<td>2.</td>
								<td>Engergy Audit Report</td>
								<td class="text-center"><a href="https://www.tmu.ac.in/pdf/environment_and_energy_audit/energy-audit-report.pdf"><i class="fa-solid fa-file-pdf"></i></a></td>
							</tr>
							<tr>
								<td>3.</td>
								<td>Environment Audit Report</td>
								<td class="text-center"><a href="https://www.tmu.ac.in/pdf/environment_and_energy_audit/environment-audit-report.pdf"><i class="fa-solid fa-file-pdf"></i></a></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="row gutter-30 col-mb-5">
						...
						<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
							...
							<div class="team-desc p-2">
								<div class="team-title pt-0">
									<h4 class="fs-14">Activities At</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i> Ginnaur Deya Mafi, Uttar Pradhesh</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-4 col-md-4">
						<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
							...
							<div class="team-desc p-2">
								<div class="team-title pt-0">
									<h4 class="fs-14">Activities At</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
