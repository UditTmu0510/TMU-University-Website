                        ...
                        <div class="container my-2 py-2">
                            <ul class="nav nav-tabs justify-content-center py-2 gap-2 gap-md-5" id="myTabs"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true"> Consultancy & <br> Research Project</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#Tab2"
                                        type="button" role="tab" aria-controls="Tab2" aria-selected="false"> Seed Money
                                        <br> Grant Scheme</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#Tab3"
                                        type="button" role="tab" aria-controls="Tab3" aria-selected="false"> Financial
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab4-tab" data-bs-toggle="tab" data-bs-target="#Tab4"
                                        type="button" role="tab" aria-controls="Tab4" aria-selected="false"> Vice
                            ...
                            <div class="tab-content second ps-5 px-md-5" id="myTabContent">
                                <div class="tab-pane fade show active" id="Tab1" role="tabpanel"
                                    ...
                                    <object
                                        data="https://www.tmu.ac.in/pdf/research/consultancy_research_project_policy.pdf"
                                ...
                                <div class="tab-pane fade" id="Tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                    <object data="https://www.tmu.ac.in/pdf/research/seed_money_policy.pdf"
                                        type="application/pdf" width="100%" height="1120px">
                                        <p>Your web browser doesn't have a PDF plugin. Instead you can
                                        </p>
                                        <center><a type="button"
                                ...
                                <div class="tab-pane fade" id="Tab3" role="tabpanel" aria-labelledby="tab3-tab">
                                    <object data="https://www.tmu.ac.in/pdf/research/incentive_policy.pdf"
                                        type="application/pdf" width="100%" height="1120px">
                                        <p>Your web browser doesn't have a PDF plugin. Instead you can
                                        </p>
                                        <center><a type="button"
                                ...
                                <div class="tab-pane fade" id="Tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                    <object data="https://www.tmu.ac.in/pdf/research/ipr_policy.pdf"
                                        type="application/pdf" width="100%" height="1120px">
                                        <p>Your web browser doesn't have a PDF plugin. Instead you can
                                        </p>
                                        <center><a type="button"
                                ...
                                <div class="tab-pane fade" id="Tab5" role="tabpanel" aria-labelledby="tab4-tab">
                                    <object data="https://www.tmu.ac.in/pdf/research/innovation_fund.pdf"
                                        type="application/pdf" width="100%" height="1120px">
                                        <p>Your web browser doesn't have a PDF plugin. Instead you can
                                        </p>
                                        <center><a type="button"
