...
<div class="col-12 col-md-9 col-lg-10 mt-3 mt-sm-0 pt-3 pt-md-5 px-4">
  ...
  <<div class="row mx-0">
                        ...
                        <div>
                            ...
                            <p class="mb-1 mt-1"><b> *Amended w.e.f. January 01, 2020, as per UGC <a href="https://www.tmu.ac.in/pdf/research/DO-NO-F-1-12018_compressed.pdf"> D.O.
                            ...
                            <div class="card mb-3 mt-2">
                                <div class="card-body">
                                    ...
                                    <p style="text-align:justify">The research scholar shall submit a draft copy of the
                                        review of literature duly recommended by his supervisor(s) to the concerned
                                        college/department of the university.
                                        The review of literature shall be evaluated by an external subject expert
                                        nominated by the Vice Chancellor who shall submit his assessment/recommendations
                                        to the university as to whether the review of literature be accepted/accepted
                                        with minor suggestions; referred to the scholar for submission in revised form;
                                        or cannot be accepted in the present form and to be resubmitted. If the expert
                                        recommends the revision/re-submission, the research scholar shall be required to
                                        submit the revised draft copy of the review of literature after incorporating
                                        the recommendations and suggestions through the research supervisor for the
                                        review of CRC whose decision shall be final for grading of the research
                                        scholar’s performance in the review of literature.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list ps-5">
                                <li><b>Scientific Research:</b> Meaning and characteristics of scientific research,
                                    ...
                                    problems in research; constructs and variables- nature of construct and variables,
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list">
                                ...
                                <li>Allen T Harrell, New Methods in Social Science Researchs, Praeger Publishers, New
                                    York.</li>
                                <li>Beri, G.C., Statistics for Management, Tata MacGraw-Hill.</li>
                                <li>Chandan J. S., Statistics for Business and Economics, Vikas Publications.</li>
                                <li>Broota, K.D., Experimental Designs in Behavioural Research, New Age International.
                                </li>
                                <li>Singh A. K., Test Measurement and Research Methods in Behaviours Sciences, Bharti
                                    Bhawan.</li>
                                <li>Joyce Cox & Polly Urban, Microsoft Office, Galgotia Publishing.</li>
                                <li>Sinha P.K., Computer Fundamentals, BPB Publishing.</li>
                                <li>*Latest editions of all the suggested books are recommended.</li>
                            </ol>
                            </p>
                        </div>
                        <hr class="horizontal-line">
                        ...
                        <h3 class="tmu-text-primary"><span>Syllabus for Coursework (Quantitative Methods and Computer
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list ps-5">
                                ...
                                <li><b>Data Collection, Processing and Analysis:</b> Methods of data collection –
                                    ...
                                    method of data collection; coding, editing and tabulation of data, charts and
                                    diagrams used in data analysis, bar and pie diagrams and their significance;
                                    measures of central tendency, measures of dispersion; correlation and regression
                                    analysis - meaning and uses, methods of calculation of coefficients and their
                                    analysis and implication. sampling distribution, sampling schemes and sample sizes,
                                    confidence interval for the mean, t-statistic, z-statistic, confidence interval for
                                    the population variances, hypothesis testing, test of hypothesis for the population
                                ...
                                <li><b>Report Writing: </b> Meaning and significance of report writing, types of report,
                                    ...
                                    application of statistical tests/techniques through the use of statistical software
                                    like SPSS, scientific packages like LISREL, AMOS, and SYSTAT for documentation and
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list ps-4">
                                <li>Cooper & Schindler, Business Research Methods, Tata McGraw Hill.</li>
                                <li>Malhotra Naresh K., Marketing Research, Pearson Education.</li>
                                <li>Power Analysis for Experimental Research: A Practical Guide for the Biological,
                                    Medical and Social Sciences by R. Barker Baushell, Yu-Fang Li, Cambridge University
                                    Press.</li>
                                <li>Chandan J. S., Statistics for Business and Economics, Vikas Publications.</li>
                                <li>Broota, K.D., Experimental Designs in Behavioral Research, New Age International.
                                </li>
                                <li>Singh A. K., Test Measurement and Research Methods in Behavioral Sciences, Bharti
                                    Bhawan.</li>
                                <li>Joyce Cox & Polly Urban, Microsoft Office, Galgotia Publishing.</li>
                                <li>Sinha P.K., Computer Fundamentals, BPB Publishing.</li>
                                <li>LaTeX: A Document Preparation System, 2/E Pearson Low Price Edition by Lamport.</li>
                                <li>MATLAB: An Introduction with Applications by Gilat, Wiley India Pvt. Ltd.</li>
                                <li>Getting Started with MATLAB by Rudra Pratap, Oxford University Press.</li>
                                <li>*Latest editions of all the suggested books are recommended.</li>
                            </ol>
                            </p>
                        </div>
                        ...
                        <h3 class="tmu-text-primary"><span>Review of Literature </span><span> COURSE CODE:
                                RMGT171</span></h3>
                        <hr class="horizontal-line">
                        <button class="careers-accordion">Objective <span class="icon">+</span></button>
                        <div class="panel">
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list ps-5">
                                <li>The research scholar will review the important studies conducted at the national and
                                    ...
                                    these studies. Based on this review of literature the researcher will identify the
                                    research gaps existing in the available literature and thus justifying the need for
                                    the present study.</li>
                                <li>The researcher is supposed to follow the pattern adopted in the standard national
                                    ...
                                    <ol class="m-ol-list ps-5">
                                        <li>Tiwari and Sinha (1971) gave productivity trends and factor compensation in
                                            ...
                                            on average for the industry as a whole, is found to be lower in the
                                            sub-period (1946-55) and higher during (1956-65). Conversely, the estimates
                                            of the marginal productivity of labor again, on average, exhibit an actual
                                            decline from 2.9 percent to 2.5 percent.</li>
                                        <li>Menon (1971), in his review article, examines the concepts associated with
                                            the measurement of productivity at various dimensions of output and input,
                                            which are the major elements involved in the exercise of measuring
                                            productivity.</li>
                                        <li>Kumar, Anil, and Khurana (2007), in their paper, have examined trends in
                                            productivity of labor and capital in the dairy industry in India during pre
                                            and post-reform periods. The results in the study conclude that labor
                                            productivity at the national level has shown considerable improvement during
                                            the post-reform period. But variations have been observed in the growth rate
                                            of labor productivity at the state level. On the other hand, capital
                                            productivity has declined during the post-reform period at national and
                                            state levels.</li>
                                        <li>Kumar and Bala (2007), in their study on "An evaluation of the impact of
                                            economic reforms on the growth and productivity of the Indian small-scale
                                            sector," have concluded that the economic reforms process initiated in the
                                            early nineties has had a downbeat impact on the growth and productivity of
                                            the small-scale sector.</li>
                                    </ol>
                                </li>
                            </ol>
                            </p>
                        ...
                        <h3 class="tmu-text-primary"><span>Research and Publication Ethics (RPE) </span><span> COURSE
                        ...
                        <div class="panel">
                            ...
                            <ol class="m-ol-list ps-5">
                                ...
                                <li><strong>Evaluation:</strong> Continuous assessment will be done through tutorials,
                                    assignments, quizzes, and group discussions. Weightage will be given for active
                                    participation. A final written examination will be conducted at the end of the
                                    course.</li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>RPE 05</td>
                                            <td>Publication Misconduct</td>
                                            <td>4</td>
                                        </tr>
                                        <tr>
                                            <td>RPE 06</td>
                                            <td>Databases and Research Metrics</td>
                                            <td>7</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                        ...
                        <p><span >Note:</span> 70% attendance
                        ...
                        <object data="https://www.tmu.ac.in/pdf/research/nursing_syllabus.pdf" type="application/pdf" width="100%" height="1100px">
                            <p>Your web browser doesn't have a PDF plugin. Instead you can</p>
                            <center><a type="button" class="btn btn-success btn-lg btn-rounded text-lg waves-effect waves-light" href="https://www.tmu.ac.in/pdf/research/nursing_syllabus.pdf" download="" data-uw-pdf-br="2" data-uw-pdf-doc=""><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
                        </object>
                        <hr>

                        <p class="mb-2 fw-bold">The details of the above courses can be accessed on the following link of INDIAN NURSING
                            COUNCIL NOTIFICATION New Delhi, the 6th November, 2020.</p>
                        <!-- container ends -->
                    </div>
                </div>
            </div>
