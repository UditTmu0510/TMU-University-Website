...
<div class="row mx-0">
                        <h1 class="tmu-text-primary tmu-page-heading"><span>Phd</span><span> Fee Structure</span></h1>
                        ...
                        <div class="container my-2 py-2">
                            <ul class="nav nav-tabs justify-content-center py-2 gap-2 gap-md-5" id="myTabs"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true"> Medical Sciences</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#Tab2"
                                        type="button" role="tab" aria-controls="Tab2" aria-selected="false"> Dental
                                        Sciences</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#Tab3"
                                        type="button" role="tab" aria-controls="Tab3" aria-selected="false">Jain
                                        Studies</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab5-tab" data-bs-toggle="tab" data-bs-target="#Tab5"
                                        type="button" role="tab" aria-controls="Tab4" aria-selected="false"> Other
                                        Programmes</button>
                                </li>
                            </ul>
                            <div class="tab-content second ps-3" id="myTabContent">
                                <div class="tab-pane fade show active" id="Tab1" role="tabpanel"
                                    ...
                                    <div class="alert alert-success">
                                        <ol class="m-ol-list ps-3">
                                            <li>An extension fee of <i class="fa fa-inr"></i> 2,00,000 per year will be
                                            ...
                                            <li>The above extension fee will not be applicable to women who fall under
                                                the purview of Clause 11.3 of the <a
                                                    href="https://www.tmu.ac.in/tmu/phd-ordinance-2017"
                                ...
                                <div class="tab-pane fade" id="Tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                    ...
                                    <div class="alert alert-success">
                                        <ol class="m-ol-list ps-3">
                                            <li>An extension fee of <i class="fa fa-inr"></i> 50,000 per year will be
                                                charged after the completion of third year of registration</li>
                                            <!--<li >Late Fee of <i class="fa fa-inr"></i> 2,000/- will be charged if the candidate exceeds the deadline by 15 days and <i class="fa fa-inr"></i> 1,000/- per 15 days or part thereof for any further delay.</li>-->
                                            <li>As per the updated guidelines released on February 01, 2022, a late fee
                                                fine at the rate of 9% p.a., on the tuition fee will be charged if the
                                            ...
                                            <li>The above extension fee will not be applicable to women who fall under
                                                the purview of Clause 11.3 of the <a
                                                    href="https://www.tmu.ac.in/tmu/phd-ordinance-2017-revised"
                                                    target="_blank">Ph.D. Ordinance</a> of the University.</li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="Tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                    <p class="text-justify mb-3">The fee payable by the research scholar enrolled for
                                        the Regualr Ph.D. program shall be as under w.e.f. TRAT January 2024</p>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed mb-none">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">3</td>
                                                    <td>I<sup>st</sup> Installment of Fee</td>
                                                    <td>15 days before the expiry of first year of Registration</td>
                                                    <td>80,000/- </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">4</td>
                                                    <td>II<sup>nd</sup> Installment of Fee</td>
                                                    <td>15 days before the expiry of second year of Registration</td>
                                                    <td>80,000/- </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">5</td>
                                                    <td>III<sup>rd</sup> Installment of Fee</td>
                                                    <td>15 days before the expiry of third year of Registration</td>
                                                    <td>80,000/- </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">6</td>
                                                    <td>IV<sup>th</sup> Installment of Fee</td>
                                                    <td>At the time of thesis submission </td>
                                                    <td>60,000/- </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="alert alert-success">
                                        <ol class="m-ol-list ps-3">
                                            <li>An extension fee of <i class="fa fa-inr"></i> 15,000 per year will be
                                                charged after the completion of third year of registration for the
                                                scholars pursuing Ph.D. in regular mode.</li>
                                            <li>Late fee fine at the rate of 9% per annum.</li>
                                            <li>The above extension fee will not to applicable to women who fall under
                                                the purview of clause 12.3 of the Ph.D. Ordinance of the University.
                                            </li>
                                        </ol>
                                    </div>
                                    <br>
                                    <p class="text-justify mb-3">The fee payable by the research scholar enrolled for
                                        the Part-Time Ph.D. program shall be as under w.e.f. TRAT January 2024</p>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed mb-none">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">6</td>
                                                    <td>IV<sup>th</sup> Installment of Fee</td>
                                                    <td>15 days before the expiry of fouth year of Registration</td>
                                                    <td>50,000/- </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">7</td>
                                                    <td>V<sup>th</sup> Installment of Fee</td>
                                                    <td>15 days before the expiry of fifth year of Registration</td>
                                                    <td>50,000/- </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">8</td>
                                                    <td>VI<sup>th</sup> Installment of Fee</td>
                                                    <td>At the time of thesis submission </td>
                                                    <td>50,000/- </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="alert alert-success">
                                        <ol class="m-ol-list ps-3">
                                            <li>An extension fee of <i class="fa fa-inr"></i> 15,000 per year will be
                                                charged after the completion of fifth year of registration for the
                                                scholars pursuing Ph.D. in part-time mode.</li>
                                            <li>Late fee fine at the rate of 9% per annum.</li>
                                            <li>The above extension fee will not to applicable to women who fall under
                                                the purview of clause 12.3 of the Ph.D. Ordinance of the University.
                                            </li>
                                ...
                                <div class="tab-pane fade" id="Tab5" role="tabpanel" aria-labelledby="tab5-tab">
                                    <p style="text-align:justify">The fee payable by the candidate/research scholar
                                        enrolled for the Ph.D. program shall be as under:</p>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed mb-none">
                                            <thead>
                                    ...
                                    <div class="alert alert-success">
                                        <ol class="m-ol-list ps-3">
                                            ...
                                            <li style="text-align:justify">As per the updated guidelines released on
                                                February 01, 2022, a late fee fine at the rate of 9% p.a., on the
                                                tuition fee will be charged if the candidate exceeds the deadline.</li>
                                            <li style="text-align:justify">The above extension fee will not be
                                                applicable to women who fall under the purview of Clause 11.3 of the <a
                                                    href="https://www.tmu.ac.in/tmu/phd-ordinance-2017"
                                                    target="_blank">Ph.D. Ordinance</a> of the University.</li>
                                            <li style="text-align:justify">These guildelines will be effected from
                                                <strong> January TRAT 2024.</strong></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
