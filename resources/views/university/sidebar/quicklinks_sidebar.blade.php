<div class="main-sidebar" id="main-sidebar">
    ...
    <div class="custom-menu-section">
        ...
        <div class="account-section">
            <a href="{{route('greviances.about')}}" class="custom-menu-item">
                <p>Greviance Portal</p>
            </a>
            <a href="{{route('disciplinary.rules')}}" class="custom-menu-item ">
            ...
            <a href="{{route('university.anti.ragging.committee')}}" class="custom-menu-item">
                <p>Anti Ragging Committee</p>
            </a>
            <a href="{{route('university.academic.calendar')}}" class="custom-menu-item">
                <p>University Academic Calendar</p>
            </a>
            <a href="{{route('nss.about')}}" class="custom-menu-item">
                <p>NSS Unit</p>
            </a>
             <a href="/https://www.tmu.ac.in/pdf/anti_ragging_policy/anti-ragging-policy.pdf" class="custom-menu-item active">
                <p>Anti Ragging Policy</p>
            </a>
            <a href="{{route('university.sports.calendar')}}" class="custom-menu-item">
