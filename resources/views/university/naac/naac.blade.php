					...
					<div class="iqac-container">
						<div class="iqac-card">
							<div class="card-pdf">
								...
								<a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('/assets/pdf/SSR_TMU.pdf')}}">View PDF</a>
							</div>
							<div class="card-pdf">
								<img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
								<p class="description">Institutional Information for Quality Assessment(IIQA)</p>
								<a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('/assets/pdf/iiqa.pdf')}}">View PDF</a>
							</div>
							<div class="card-pdf">
								<img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
								<p class="description">Peer Team Report on Institutional Accreditation</p>
								<a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
									href="{{asset('/assets/pdf/Peer_Team_Report_TMU.pdf')}}">View PDF</a>
							</div>
							<div class="card-pdf">
								<img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
								<p class="description">Grade Sheet </p>
								<a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
									href="{{asset('/assets/pdf/Institutional_Grade_Sheet.pdf')}}">View PDF</a>
							</div>
							<div class="card-pdf">
								<img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
								<p class="description">Graphical Representation based on Quantitative & Qualitative Metrics</p>
								<a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
									href="{{asset('/assets/pdf/Graphical_representation_based_on_QnM_and_QlM.pdf')}}">View PDF</a>
							</div>
						</div>
					</div>
							...
							<div class="row impe-plac-row mb-4">
								<div class="col-lg-6 col-md-6 col-sm-6 text-center mb-0">
									<div class="border-box-iqac">
										<a class="colmd-4" href="{{asset('/assets/img/department/naac/naac.jpg')}}" data-lightbox="image" title=""
											data-zoom="true">
											<div class="grid-inner mb-2">
												<img src="{{asset('/assets/img/department/naac/naac.jpg')}}" height="600" width="500"
													alt="Single Image">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 text-center mb-0">
									<div class="border-box-iqac">
										<a class="colmd-4" href="{{asset('/assets/img/department/naac/naac_cycle_1_certificate.jpg')}}"
											data-lightbox="image" title="" data-zoom="true">
											<div class="grid-inner mb-2">
												<img src="{{asset('/assets/img/department/naac/naac_cycle_1_certificate.jpg')}}" height="600"
