    ...
    <div class="row mx-0 mb-5">
      ...
      <div id="" class="mb-20 last:mb-0">
        <div class="richtext fancylists prose-body mb-1 text-justify">
          <p>The Internal Quality Assurance Cell (IQAC) is the cell that is formulated for monitoring the quality
            parameters in TMU. The Composition of IQAC members as per the recommendations given by National Assessment
      ...
      <ol class="m-ol-list ps-5 mb-2 text-justify">
        <li>To ensure progressive and efficient performance of academic, administrative, and financial tasks in a timely
          manner.</li>
        <li>Evolve mechanisms for assessing and ensuring the relevance and quality of academic and research programs.
        </li>
      ...
      <ol class="m-ol-list ps-5 mb-2 text-justify">
        ...
        <li>Creating awareness on various quality parameters of higher education through seminars, lectures, and
          workshops.</li>
        <li>Documentation of the various programs/activities leading to quality improvement.</li>
        <li>Acting as a nodal agency of the University for coordinating quality-related activities, including adoption
          and dissemination of best practices.</li>
        <li>Development and maintenance of University database through ERP for the purpose of maintaining/enhancing
          institutional quality.</li>
        <li>Development of Quality Culture in the University.</li>
        <li>Preparation of the Annual Quality Assurance Report (AQAR) as per guidelines and parameters of NAAC, to be
          submitted to NAAC.</li>
      </ol>
      ...
      <ol class="m-ol-list ps-5 mb-2 text-justify">
        ...
        <li>Ensure enhancement and coordination among various activities of the institution and institutionalize all
          good practices.</li>
      ...
      <ol class="m-ol-list ps-5 mb-2 text-justify">
        ...
        <li>Continuous improvement in academic and non-academic activities of the university</li>
