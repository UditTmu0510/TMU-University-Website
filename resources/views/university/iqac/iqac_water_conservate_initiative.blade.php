...
<div class="main-content">
  <div class="container">
    <div class="row mx-0">
      <h1 class="tmu-text-primary tmu-page-heading pt-md-5"><span>Water Conservation</span> <span>Initiatives</span></h1>
      <div class="container mb-5 mt-3">
        ...
        <div class="panel">
          ...
          <ul class="m-ol-list ps-4">
            <li>Usage of Water is Variable <b class="fs-16">(Due to different Weather Condition)</b>.</li>
