  ...
  <div class="container">
    ...
    <div class="iqac-container">
      <div class="iqac-card">
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(28)</b> - Re-Activation of Year Back Students</p>
        ...
        <div class="card-pdf">
          ...
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_29.pdf')}}" target="_blank">View
            PDF</a>
        </div>
