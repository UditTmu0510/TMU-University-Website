  ...
  <div class="container">
    ...
    <div class="iqac-container">
      <div class="iqac-card">
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(2)</b> - Research Promotion (Incentive) Policy</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(3)</b> - Consultancy Policy</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
            href="{{asset('/assets/pdf/policy/consultancy_policy.pdf')}}" target="_blank">View PDF</a>
        </div>
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(4)</b> - Seed Money Grant Scheme</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(14)</b> - Service Rule</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(15)</b> - Faculty Recruitment Policy</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>POL(16)</b> - E-Governance (ERP) Policy</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
            href="{{asset('/assets/pdf/erp_policy.pdf')}}" target="_blank">View PDF</a>
        </div>
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
    ...
    <div class="iqac-container">
      <div class="iqac-card">
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(1)</b> - Organizing Academic Events Sop</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(2)</b> - Student Attendance Monitoring SOP</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(12)</b> - Academic Review Visits in Colleges</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('/assets/pdf/policy/sops/Academic_Review.pdf')}}" target="_blank">View
            PDF</a>
        </div>
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(13)</b> - Identification of Slow and Advanced Learners (Process and Outcome)</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(16)</b> - Research Excellence Awards</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(17)</b> - Conduction of Pre-thesis Submission Presentation and Oral Defense Examination/Final Viva-Voce</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(19)</b> - Organizing Inter-University/College Events for Students</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('/assets/pdf/policy/sops/SOP-19.0.pdf')}}" target="_blank">View
            PDF</a>
        </div>
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(20)</b> - Process for approval of No Dues of Student</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(21)</b> - Students participation in events conducted Outside University</p>
        ...
        <div class="card-pdf">
          <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
          <p class="description"><b>SOP(27)</b> - Developing E-Content at Teerthanker Mahaveer University</p>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_27.pdf')}}" target="_blank">View
            PDF</a>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_27_annexure_1.pdf')}}" target="_blank">View
           Annexure - 1</a>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_27_annexure_2.pdf')}}" target="_blank">View
           Annexure - 2</a>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_27_annexure_3.pdf')}}" target="_blank">View
           Annexure - 3</a>
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-1" href="{{asset('/assets/pdf/policy/sops/SOP_27_annexure_4.pdf')}}" target="_blank">View
           Annexure - 4</a>
        </div>
