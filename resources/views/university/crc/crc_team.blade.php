        ...
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">+91-7055317317</p>
              <p class="card-text fs-14 tmu-color-blue">sidhart.crc@tmu.ac.in</p>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">+91-9927670666</p>
              <p class="card-text fs-14 tmu-color-blue">riteeshsrivastva.crc@tmu.ac.in</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">Assistant Director (CRC)</p>
              <p class="card-text fs-14 tmu-color-blue">+91-8209239543</p>
              <p class="card-text fs-14 tmu-color-blue">placementcell@tmu.ac.in</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">+91-7983275334</p>
              <p class="card-text fs-14 tmu-color-blue">crcdata@tmu.ac.in</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">+91-8923984164</p>
              <p class="card-text fs-14 tmu-color-blue">shudhanshu.crc@tmu.ac.in</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
          <div class="card card-animation">
            ...
            <div class="card-body text-center">
              ...
              <p class="card-text fs-14 tmu-color-blue">Executive (CRC)</p>
              <p class="card-text fs-14 tmu-color-blue">+91-7983275334</p>
              <p class="card-text fs-14 tmu-color-blue">mehvish.crc@tmu.ac.in</p>
            </div>
          </div>
        </div>
