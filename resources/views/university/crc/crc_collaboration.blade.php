...
<div class="main-content">
    <div class="container">
        <h1 class="tmu-text-primary tmu-page-heading pt-md-5"><span> Industrial </span><span> Collaboration </span></h1>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="section-box p-3" height="250px!important">
                        ...
                        <div class="course-content">
                            ...
                            <ul class="m-ol-list ps-5 mt-0">
                                <li>System Administration II</li>
                                <li>System Administration III</li>
                                <li>XXX</li>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="section-box p-3">
                        ...
                        <div class="course-content">
                            ...
                            <ul class="m-ol-list ps-5 mt-0">
                                <li>Auto CAD 3D</li>
                                <li>STADPRO, SOLID WORKS</li>
                                <li>Quality Takeoff and MATLAB</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="section-box p-3">
                        ...
                        <div class="course-content">
                            ...
                            <ul class="m-ol-list ps-5 mt-0">
                                <li>Training in Siemens</li>
                                <li>Training in Delta</li>
                                <li>Training in PLCs</li>
                                <p>&nbsp;</p>
                            </ul>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="section-box p-3">
                        ...
                        <div class="course-content">
                            ...
                            <ul class="m-ol-list ps-5 mt-0 mb-0">
                                <li class="fs-14">Training on Android APP Development</li>
                                <li class="fs-14">Training in Data Centre Infrasturcture Design</li>
                            </ul>
                        </div>
                    </div>
                </div>
