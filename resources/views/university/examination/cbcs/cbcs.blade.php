        ...
        <tbody>
          <tr>
            ...
            <td colspan="2" rowspan="4">
              <center>Faculty of Education</center>
            </td>
            <td>1.</td>
          ...
          <tr>
            ...
            <td colspan="2" rowspan="2">
              <center>College of Physical Education</center>
            </td>
            <td>5.</td>
          ...
          <tr>
            ...
            <td rowspan="12" colspan="2">
              <center>College of Computing Sciences & IT</center>
            </td>
            <td>19.</td>
            <td>Data Science</td>
            <td>OECOP101</td>
          ...
          <tr>
            <td rowspan="2">5.</td>
            <td colspan="2" rowspan="2">
              <center>College of Agricultural Sciences</center>
            </td>
            <td>31.</td>
          ...
          <tr>
            ...
            <td colspan="2" rowspan="3">
              <center>TMIMT College of Management</center>
            </td>
            <td>33.</td>
          ...
          <tr>
            <td rowspan="4">7.</td>
            <td colspan="2" rowspan="4">
              <center>College of Paramedical Sciences</center>
            </td>
            <td>36.</td>
            <td>FIRST AID</td>
            <td>OEPAR101</td>
          ...
          <tr>
            <td rowspan="4">8.</td>
            <td colspan="2" rowspan="4">
              <center>Department of Physiotherapy</center>
            </td>
            <td>40.</td>
          ...
          <tr>
            <td rowspan="4">9.</td>
            <td colspan="2" rowspan="4">
              <center>College of Nursing</center>
            </td>
            <td>44.</td>
          ...
          <tr>
            <td>10.</td>
            <td colspan="2">
              <center>College of Pharamacy</center>
            </td>
            <td>48.</td>
          ...
          <tr>
            <td rowspan="4">11.</td>
            <td colspan="2" rowspan="4">
              <center>College of Fine Arts</center>
            </td>
            <td>49.</td>
          ...
          <tr>
            <td rowspan="4">12.</td>
            <td colspan="2" rowspan="4">
              <center>College of Law Legal Studies</center>
            </td>
            <td>53.</td>
