...
<section id="content">
    <div class="content-wrap py-0">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active hero-slide">
                        ...
                        <div class="content-overlay">
                            <div class="container">
                                <h1 class="section-title d-none d-lg-block" style="color: white;">Sports <span></span></h1>
        ...
        <div class="container">
            ...
            <h2 Class="tmu-text-primary my-0 d-block d-lg-none text-center"><span>Sports </span><span></span></h2>
        ...
        <section class="gallery-section">
            <div class="container">
                ...
                <h2 Class="tmu-text-primary mb-2 mt-5"><span>Sports </span><span>Gallery</span></h2>
                    <p class="lead">Explore our stadiums through these captivating images</p>
                </div>
