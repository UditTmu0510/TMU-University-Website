      ...
      <div class="iqac-card">
        <div class="card-pdf">
          ...
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
            href="https://www.tmu.ac.in/pdf/sss-reports/SSS-Report-20-21_compressed.pdf">APPLY HERE</a>
        </div>
        <div class="card-pdf">
          <!-- <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon"> -->
          ...
          <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
            href="https://www.tmu.ac.in/pdf/sss-reports/SSS-Report-20-21_compressed.pdf">DOWNLOAD FORM</a>
        </div>
      </div>
    </div>
    <div class="container py-2 px-lg-5">
