...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="fw-bolder tmu-text-primary text-center mt-5" style="font-size:2.5rem"><span>All</span><span>
                        Blogs</span></h1>
            </div>
        </div>
    </div>
                                    ...
                                    <a href="{{ url('blog/' . $item->n_slug) }}" class="text-decoration-none text-reset">
                                        <div class="text-justify-centre">
                                            @if ($item->monaco_image_path != 0 && $item->monaco_image_path != null)
                                                ...
                                                <img src="{{ asset($item->monaco_image_path) }}"
                                                    alt="{{ $item->post_title }}" />
                                            @else
                                                <!-- Background blur effect for post_path -->
                                                <div class="image-container889">
                                                    <div class="blurred-background"
                                                        style="background-image: url('{{ asset($item->post_path) }}');">
                                                    </div>
                                                    <img src="{{ asset($item->post_path) }}"
                                                        alt="{{ $item->post_title }}" />
                                                </div>
                                            @endif
                                            ...
                                            <div class="blog-content">
                                                ...
                                                <div class="blog-description">{{ Str::limit($item->post_description, 40) }}
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    <div class="row p-2 mb-3 snipcss0-0-0-1 snipcss-o1qON style-pe7mR" id="style-pe7mR">
                        ...
                        <div class="row ">
                            @foreach ($blogs->take(4) as $item)
                                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-12 my-3 px-2 text-justify-centre mx-auto ">
                                    <div id="blog_box"
                                        class="shadow bg-white overflow-hidden rounded-box p-0 snipcss0-3-4-5">
                                        <a href="{{ url('blog/' . $item->n_slug) }}"
                                            ...
                                            <div class="blog-card text-justify-centre">
                                                ...
                                                <div class="blog-content">
                                                    ...
                                                    <div class="blog-description">
                                                        {{ Str::limit($item->post_description, 40) }}</div>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
