              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards"> 
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">{{ optional($hod->designation_name)->designation_name ?? 'No Designation Available' }},{{ optional($hod->college_name)->cd_name ?? 'No College Available' }}</p>
