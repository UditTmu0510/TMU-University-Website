...
<div class="main-content">
  <div class="container">
    <div class="row mx-0">
      <h1 class="mb-2 tmu-text-primary tmu-page-heading pt-md-5"><span>University </span><span class="d-block d-sm-inline">
          Governance</span></h1>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Former Dean</td>
                  <td>Faculty of Management, BHU, Varanasi</td>
                  <td>Member</td>
                </tr>

                <tr>
                  <td> Prof. Sachin S. Varnekar</td>
                  <td>Professor Emeritus</td>
                  <td>Dr DY Patil Vidyapeeth ,Pune</td>
                  <td>Member</td>
                </tr>
                ...
                <tr>
                  <td>Prof. S K Jain </td>
                  <td>Dean-Medical</td>
                  <td>Teerthanker Mahaveer Medical College and Research Centre, Moradabad</td>
                  <td>Member</td>
                </tr>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Principal</td>
                  <td>College of Computing Science & Information Technology, Delhi Road, Moradabad</td>
                  <td>Member</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>Principal</td>
                  <td>Teerthanker Mahaveer Medical college & Research Centre, Delhi Road, Moradabad</td>
                  <td>Member</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>Principal</td>
                  <td>Teerthanker Mahaveer Dental college & Research Centre, Delhi Road, Moradabad</td>
                  <td>Member</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>College of Computing Science & Information Technology, TMU, Delhi Road, Moradabad</td>
                  <td>Member</td>
                </tr>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <center><a
                        href="{{asset('/assets/pdf/bos_minutes/FOE/23-24/Civil.pdf')}}"
                        target="_blank">View (Civil)</a></center>
                    <center><a
                        href="{{asset('/assets/pdf/bos_minutes/FOE/23-24/Chemistry.pdf')}}"
                        target="_blank">View (Chemsitry)</a></center>
                    <center><a
                        href="{{asset('/assets/pdf/bos_minutes/FOE/23-24/EE.pdf')}}"
                        target="_blank">View (EE)</a></center>
                    <center><a
                        href="{{asset('/assets/pdf/bos_minutes/FOE/23-24/EC.pdf')}}"
                    ...
                    <center><a
                        href="{{asset('/assets/pdf/bos_minutes/FOE/23-24/ME.pdf')}}"
                        target="_blank">View (ME)</a></center>
                  </td>
