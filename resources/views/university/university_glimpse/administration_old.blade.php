              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">vicechancellor@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">registrar@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2476813</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dean@tmu.ac.in</p>
                    <p class="card-text fs-14">0591-2476800</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">coe@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360078</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">studentswelfare@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">finance.off@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2476812</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dir.hr@tmu.ac.in</p>
                    <p class="card-text fs-14">05912476840</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dir_governance.dahs@tmu.ac.in</p>
                    <p class="card-text fs-14">05912476800</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">jt.director.oea@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-9917302555</p>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">sidharth.crc@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-7055317317</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">ad.academics@tmu.ac.in</p>
                    <p>&nbsp;</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">+91-9634232666</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">jt.registrar.alumni@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-9258118526</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">jointregistrar@tmu.ac.in</p>
                    <p>&nbsp;</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">manoj.rana@tmu.ac.in</p>
                    <p>&nbsp;</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">ar.tmimt@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2487222</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">head.dm@tmu.ac.in</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dean.medical@tmu.ac.in</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dean.law@tmu.ac.in</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">dean.agriculture@tmu.ac.in</p>
                  </div>
                </div>
              </div>
            </div> 
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.medical@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2476815</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.dentl@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.pharmacy@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.computers@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.management@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.law@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <h5 class="card-title tmu-text-primary fw-bold"><span></span><span>Prof. R. K. Dwivedi</span></h5>
                    ...
                    <p class="card-text fs-14">principal.engineering@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.education@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">director.ctld@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                    </p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.finearts@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591–2476836</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards">
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.physicaleducation@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591-2360222</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation admin-cards"> 
                  ...
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    ...
                    <p class="card-text fs-14">principal.jainstudies@tmu.ac.in</p>
                    <p class="card-text fs-14">+91-591–2476845</p>
                  </div>
                </div>
              </div>
            </div>
