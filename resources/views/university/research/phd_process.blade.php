...
<div class="main-content">
  <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ol class="ps-3 mb-0 fs-14" style="list-style-type: decimal;">
            <li class="mb-2">Apply for TRAT by paying Re. 2000 as application fee (Jainology exempted)</li>
            <li class="mb-2"><b>2 stage Process-</b>
              <ul class="ps-4 m-ol-list">
                <li class="mb-1">Written Exam (70%)</li>
                <li class="mb-1">Interview (30%)</li>
              </ul>
            </li>
            <li class="mb-2">Appear for written test (2" Sat of July/Jan) and result to be declared
              within 04 days.</li>

            <li class="mb-2">Appear for interview/viva voce within 03 days of the written test result
              declaration, including the candidates exempted from TRAT</li>
            <li class="mb-2">TRAT result declared on the website of the university within 03 days from
              the date of interview/viva voce conducted.</li>
            <li class="mb-2">Offer of admission sent to the successful candidates, within 03 days from
            ...
            <li class="mb-2">
              <ul class="ps-4 mb-0 fs-14 m-ol-list">
                ...
                <li class="mb-1">Notification by the University about the commencement & schedule of Course
                  Work.</li>
              </ul>
            </li>
            ...
            <li class="mb-2">
              <ul class="ps-4 mb-0 fs-14 m-ol-list">
                ...
                <li class="mb-1">Call for attending the Convocation.</li>
              </ul>
            </li>
