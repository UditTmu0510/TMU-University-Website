...
@section('content')
    ...
    <div class="main-content">
        <div class="container">
            <div class="row">
                <h1 class="tmu-text-primary tmu-page-heading mb-0 mt-md-3"><span>About the</span><span> Centre for Indian
                ...
                <div class="container">
                    <h2 class="tmu-text-primary mb-2 mt-2"><span>CIKS </span><span> Objectives</span></h2>
                    <div class="d-grid-ot235 col-mb-50 mb-5">
                        <div class="grid-col-ot235">
                            <div class="icon-box-ot235">
