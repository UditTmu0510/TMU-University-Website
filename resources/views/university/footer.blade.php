                  ...
                  <abbr title="Email Address"><strong>Email:</strong></abbr> admissions@tmu.ac.in
                            ...
                            <div class="col-6 col-lg-2 widget_links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ route('tmu.media.cover') }}" target="_blank">Media Coverage</a></li>
                                    ...
                                    <li><a href="{{ route('iqac.student.feedback') }}" target="_blank">Feedback</a>
                                    </li>
                            ...
                            <div class="col-6 col-lg-2 widget_links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ route('yoga.and.meditation') }}" target="_blank">Yoga &
                                            Meditation</a></li>
                                    <li><a href="{{ route('sports') }}" target="_blank">Sports</a></li>
                                    <li><a href="{{ route('library') }}" target="_blank">Library</a></li>
                                    <li><a href="{{ route('music.and.dance.room') }}" target="_blank">Music &
                                            Dance</a></li>
            ...
            <div class="row justify-content-between">
                <div class="col-12 col-lg-auto text-center text-lg-start">
                    <div class="copyrights-menu copyright-links">
                        <a href="{{ route('university.anti.ragging.committee') }}" target="_blank">Anti
                            Ragging</a>/<a href="{{ route('nirf.home') }}" target="_blank">NIRF</a>/<a
                            href="{{ route('naac.home') }}" target="_blank">NAAC</a>/<a
