...
<div class="main-content">
    ...
    <section class="about-section bg-light mt-4 p-3">
        <div class="container">
            ...
            <h3 class="mb-2 pb-0 pt-4 tmu-text-primary fw-bold h3size"><span>Communication to</span><span> the Journal</span></h3>
            <p class="about-p pb-4 text-justify">
                All the articles must be communicated through journal email-……………….
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Structure of</span><span> the Manuscript</span></h3>
            <ul class="m-ol-list ps-5 mb-4">
                <li>TITLE</li>
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Title</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Abstract</span></h3>
            <p class="about-p pb-4 text-justify">
                A structured abstract up to 250 words, should be written including objective, methods, results
                and conclusion.
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Keywords</span></h3>
            <p class="about-p pb-4 text-justify">
                Up to 4-6 keywords must be provided in alphabetical order.
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Introduction</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Materials &</span> <span> Methods</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Results</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Discussion</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Conclusions</span></h3>
            <p class="about-p pb-4 text-justify">
                A brief paragraph summarizing the significant findings of the work is required.
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Conflict of</span> <span> Interest</span></h3>
            <p class="about-p pb-4 text-justify">
                Authors should clearly state about any conflict in the manuscript.
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Acknowledgments</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Funding</span> <span>Source </span> </h3>
            <p class="about-p pb-4 text-justify">
                Please list the source(s) of funding for the study, for each author, and for the manuscript
                preparation.
            </p>

            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>References</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Review</span><span> Article</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Short</span><span> Communications</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Case</span><span> Reports</span></h3>
            <p class="about-p pb-4 text-justify">
            ...
            <h3 class="mb-2 pb-0 tmu-text-primary fw-bold h3size"><span>Copyright</span><span> Transfer Agreement</span></h3>
            <p class="about-p pb-4 text-justify">
