        ...
        <div class="container">
			...
			<div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/pharmacy/1.jpg')}}"
                                    alt="Gallery Thumb 2">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/pharmacy/5.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/pharmacy/6.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
