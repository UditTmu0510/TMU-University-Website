...
<div class="main-content">
    <div class="container">
        <div class="banner text-white text-center p-4 rounded" style="background-color: #001055;">
            ...
            <h3 class="text-white">For any query related to TJPBS Journal, you may drop message or contact the
                officials at board.</h3>
        </div>
                ...
                <div class="col-md-6 d-flex flex-column align-items-center">
                    ...
                    <div class="contact-info w-100 mt-3">
                        <div>
                            ...
                            <div>
                                <span>Email</span>
                                <!-- <span class="text-break">principal.pharmacy@tmu.ac.in</span> -->
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div>
                                <span>Address</span>
                                <span>TMU, Delhi Road, Moradabad 244001, UP</span>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="contact-info w-100 mt-3">
