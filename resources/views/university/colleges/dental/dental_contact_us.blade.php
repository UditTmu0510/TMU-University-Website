...
<div class="main-content">
    <div class="container">
        <div class="banner text-white text-center p-4 rounded" style="background-color: #001055;">
            ...
            <h3 class="text-white">For any query related to College of dental, you may drop message or contact the
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <input type="hidden" name="cd_id" value="3" />
                ...
                <div class="col-md-6 d-flex flex-column align-items-center">
                    <div class="contact-image" style="background-image: url('https://img.freepik.com/free-photo/top-view-chat-bubbles-with-telephone-receiver-copy-space_23-2148796078.jpg');">
                    </div>
                    <div class="contact-info w-100 mt-3">
                        <div>
                            ...
                            <div>
                                <span>Email</span>
                                <span class="text-break">principal.dental@tmu.ac.in</span>
                            </div>
                        </div>
                        <div>
