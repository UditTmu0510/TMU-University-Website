            ...
            <div class="container">
                ...
                <div class="container p-3">
                    ...
                    <p class="about-p mb-4 text-justify">The orthodontics department at TMU specialises in the diagnosis and
                        ...
                        care. Our patients experience the difference in orthodontic treatment.</p>
                </div>
            </div>
        </section>
        <div class="container">
                ...
                <div class="col-md-12 mb-3">
                    <div>
                        ...
                        <p class="mb-2 text-justify">chairs and state-of-the-art cephalometric software like Nemoceph, we ensure
                            ...
                            more. In addition, the Orthopaedics department boasts a dedicated library, complementing
                            the resources available at the central library. TMU’s Department of Orthodontics and
                            Dentofacial Orthopaedics offers an environment that is designed for optimal learning and
                            exceptional patient care.</p>
                ...
                <div class="col-md-12 mb-3">
                    <div>
                        ...
                        <p class="mb-2 text-justify">TMU Hospital is a state-of-the-art medical facility that operates round the
                            ...
                            well-being. Here’s a list of the treatments provided by the Department of <span class="highlight"><a href="https://www.tmu.ac.in/dental-college-and-research-centre/orthodontics-dentofacial-orthopedics" target="_blank"> Orthodontics and Dentofacial </a></span> Orthopaedics:</p>

                        <div class="row">
                            <div class="col-md-6">
                                <ul style="list-style-type:decimal;" class="ps-5">
                                    <li>Removable Orthodontic Appliance
                                        <ul class="m-ol-list ps-5">
                                            <li>Hawleys appliance</li>
                                            <li>Hawleys with Ant. Bite plane</li>
                                            <li>Hawleys with Post Bite Plane</li>
                                            <li>Hawleys with Expansion screw</li>
                                        </ul>
                                    </li>
                                    <li>Habit Breaking Aplliance
                                        <ul class="m-ol-list ps-5">
                                            <li>Oral Screen</li>
                                            <li>Hawleys with Tongue Crib</li>
                                            <li>Hawleys with Rakes</li>
                                        </ul>
                                    </li>
                                    <li>Myofunctional Appliance
                                        <ul class="m-ol-list ps-5">
                                            <li>Twin block</li>
                                            <li>Activator</li>
                                            <li>Bionator</li>
                                            <li>Frankels Appliance</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul style="list-style-type:decimal;" class="ps-5">
                                    ...
                                    <li>Fixed Mechanotherapy
                                        <ul class="m-ol-list ps-5">
                                            <li>Roths Mechanotherapy</li>
                                            <li>MBT Mechanotherapy</li>
                                            <li>Lingual Mechanotherapy</li>
                                            <li>Beggs Mechanotherpy</li>
                                            <li>Self Ligating Mechanotherapy</li>
                                        </ul>
                                    </li>
                                    <li>Invisible Orthodontics
                                        <ul class="m-ol-list ps-5">
                                            <li>Lingual Orthodontics</li>
                                            <li>Ceramic (Clear) Orthodontics</li>
                                            <li>Invisalign/ Clear Aligner</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-left gutter-30 col-mb-5 mb-5">
                <div class="col-sm-4 col-md-4">
                    <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
                        <div class="team-image">
                            <img src="{{asset('/assets/img/college_departments/dental/odo/odo1.jpg')}}" height="150px" alt="">
                        </div>
                        <div class="team-desc p-2">
                            <div class="team-title pt-0">
                                <h4 class="fs-14"> Department of Orthodontics & Dentofacial Orthopedics </h4>
                                <span class="fst-normal fs-12 mb-2"><i class="fa-solid fa-location-dot"></i> Dental College and Research Centre, TMU Campus</span>
                                <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-4" href="{{asset('/assets/img/college_departments/dental/odo/geotag/odo1.jpg')}}" download>
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
                        <div class="team-image">
                            <img src="{{asset('/assets/img/college_departments/dental/odo/odo2.jpg')}}" height="150px" alt="">
                        </div>
                        <div class="team-desc p-2">
                            <div class="team-title pt-0">
                ...
                <div class="col-sm-4 col-md-4">
                    <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
                        <div class="team-image">
                            <img src="{{asset('/assets/img/college_departments/dental/odo/odo3.jpg')}}" height="150px" alt="">
                        </div>
                        <div class="team-desc p-2">
                            <div class="team-title pt-0">
                                <h4 class="fs-14">PG Section <br/>&nbsp;</h4>
                                <span class="fst-normal fs-12 mb-2"><i class="fa-solid fa-location-dot"></i> Dental College and Research Centre, TMU Campus</span>
                                <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12 mb-4" href="{{asset('/assets/img/college_departments/dental/odo/geotag/odo3.jpg')}}" download>
                                    Download Geo Tag Image
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" class="text-center"><strong>MAJOR</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Dental Polishing Lathe</td>
                            </tr>
                            <tr>
                                <td class="text-center">5</td>
                                <td>Electropolisher</td>
                            </tr>
                            <tr>
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" class="text-center"><strong>MINOR</strong></td>
                            </tr>
                            <tr>
                                <td class="text-center">1</td>
                                <td>Vacuum Molding Machine</td>
                            </tr>
                            <tr>
                                <td class="text-center">2</td>
