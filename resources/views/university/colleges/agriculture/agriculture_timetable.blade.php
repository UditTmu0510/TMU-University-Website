...
<div class="main-content">
    <div class="container d-none d-sm-block">
        <div style="text-align:center">
            ...
            <iframe src="{{asset('/assets/pdf/time_table/agriculture/agri_TT_25_26.pdf')}}" frameborder="0" height="800px" width="100%"></iframe>
        </div>
    </div>
            ...
            <div class="iqac-card">
                <div class="card-pdf">
                    ...
                    <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12"
                        href="{{asset('/assets/pdf/time_table/agriculture/agri_TT_25_26.pdf')}}" download>Download PDF</a>
                </div>
            </div>
        </div>
    </div>
