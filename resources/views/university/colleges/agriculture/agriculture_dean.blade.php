    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 col-lg-4 text-center img-container mb-4" style="height:fit-content;">
                <img src="https://www.tmu.ac.in/img/tmu/administration/dean/praveen_jain.jpg"
                    alt="praveen-dean-desk" height="350" width="400">
            </div>
            <div class="col-md-8">
                ...
                <p class="mb-2 text-justify">We, at the <span class="highlight"><a href="https://www.tmu.ac.in/college-of-agriculture-sciences" target="blank"> TMU’s College of Agricultural Sciences</a></span>, the top private agricultural college in UP, embrace the potential of modern agricultural technology and blend it with traditional knowledge to create innovative solutions. Our curriculum equips students with in-demand skills along with global opportunities to pursue a range of career paths. We believe that agriculture is an avenue for us to contribute to the environment and make a positive difference......</p>
                ...
                <p class="mb-2 text-justify">The College of Agriculture Sciences at <span class="highlight"><a href="https://www.tmu.ac.in/?_gl=1*1pa9czl*_gcl_au*MzUwNTMwNTguMTcxODE5NTg3OA..*_ga*ODA5MDcxMzY5LjE3MDExNDY2MzA.*_ga_QXM8FSJKVR*MTcyMTk3MzMyMi4xMDcuMS4xNzIxOTczMzI1LjU3LjAuMTY5NTM1OTcx" target="blank"> TMU Moradabad</a></span> boasts an abundance of advantages. These include experienced teachers and substantial farming acreage for hands-on learning. </p>
            </div>
            <div class="col-md-12">
