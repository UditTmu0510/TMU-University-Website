					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">Assistant Professor</td>
								<td class="text-center">Member</td>
								<td class="text-center">9870983533</td>
								<td class="text-center">drshubhendra.engineering@tmu.ac.in</td>
							</tr>
							...
							<tr>
								...
								<td class="text-center">Assistant Professor</td>
								<td class="text-center">Member</td>
								<td class="text-center">9456016503</td>
								<td class="text-center">himansh.engineering@tmu.ac.in</td>
							</tr>
							...
							<tr>
								...
								<td class="text-center">Assistant Professor</td>
								<td class="text-center">Member</td>
								<td class="text-center">9411071412</td>
								<td class="text-center">ashishs.engineering@tmu.ac.in</td>
							</tr>
							...
							<tr>
								...
								<td class="text-center">Assistant Professor</td>
								<td class="text-center">Member</td>
								<td class="text-center">9929382227</td>
								<td class="text-center">pavan.engineering@tmu.ac.in</td>
							</tr>
