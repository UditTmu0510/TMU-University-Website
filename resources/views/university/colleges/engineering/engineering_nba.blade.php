                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="ps-4 fw-bold" style="list-style-type:decimal">
                                    ...
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>NAAC & NBA</li>
                                        <a
                                            href="{{asset('assets/pdf/coe/nba/accreditation_status_compressed.pdf')}}" target="_blank">View
                                            More!</a>
                                    </ol>
                                    ...
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>Institute Presentation Link- <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/ppt/institute_level.pptx')}}" target="_blank">View
                                                More!</a></li>
                                    </ol>
                                    <li>Lab Manuals</li>
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>Basic Electronics Engineering Lab <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/lab_mannuals/basic_electronics_engineering_lab_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>Engineering Physics Lab <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/lab_mannuals/engineering_physics_lab_mannual_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>Engineering Chemistry Lab <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/lab_mannuals/lab_mannual_engineering_chemistry_lab_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>Workshop Practice Lab <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/lab_mannuals/workshop_practice_lab_mannual_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                    </ol>
                                    <li>Academic Council Minutes</li>
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>April 2021 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/april_2021_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>July 2020 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/july_2020_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>September 2019 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/september_2019_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>May 2019 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/may_2019_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>December 2018 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/december_2018_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>March 2018 <br>Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/academic_council_minutes/march_2018_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                    </ol>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="ps-4 fw-bold" style="list-style-type:decimal">
                                    ...
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>EME162 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/course_files/EME162_course_file_with_attainments_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>EEE217 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/course_files/EEE217_course_file_with_attainments_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>EAS112 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/course_files/EAS112_course_file_with_attainments_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>EAS263 <br> Link:-<a
                                                href="{{asset('assets/pdf/coe/nba/course_files/EAS263_course_file_with_attainments_compressed.pdf')}}" target="_blank">View
                                                More!</a></li>
                                    </ol>
                                    <li>First Year Faculty List</li>
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li>2018-19 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/First_Year_Faculty_List_2018-19.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>2019-20 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/First_Year_Faculty_List_2019-20.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>2020-21 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/First_Year_Faculty_List_2020-21.pdf')}}" target="_blank">View
                                                More!</a></li>
                                        <li>2021-22 <br> Link:- <a
                                                href="{{asset('assets/pdf/coe/nba/First_Year_Faculty_List_2021-22.pdf')}}" target="_blank">View
                                                More!</a></li>

                                    </ol>
                                    <li>Complete Faculty List</li>
                                    <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                        <li><a href="{{asset('assets/pdf/coe/faculty_details_finalized.pdf')}}" target="_blank">Faculty List Link</a></li>
                                    </ol>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <li>Accreditation Status
                                        <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal fs-14 fw-normal">
                                            <li>NAAC & NBA<br> Link: <a
                                                    href="{{asset('assets/pdf/coe/nba/accreditation_status_compressed.pdf')}}" target="_blank" >View More!</a>
                                            </li>
                                        </ol>
                                    </li>
                                        ...
                                        <ol class="m-ol-list ps-4 mb-3 fs-14 fw-normal">
                                            <li>Syllabus of different programmes of the Faculty of
                                                Engineering<br />Link-<a
                                                    href="{{route('engineering.syllabus')}}"
                                                    target="_blank">View More!</a>
                                            </li>
                                        </ol>
                                    </li>
