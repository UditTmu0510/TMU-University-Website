            ...
            <div class="iqac-container">
                <div class="iqac-card">
                    <div class="card-pdf">
                        ...
                        <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('assets/pdf/academic_calendars/physical_education/Academic-Calendar-24-25.pdf')}}">Download PDF</a>
                    </div>
                    <div class="card-pdf">
                        <img src="{{asset('/assets/img/icons/sheet.svg')}}" alt="PDF Icon" class="pdf-icon">
                        <p class="description">Annual Calendar <br><b>2024 - 25</b></p>
                        <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{asset('assets/pdf/academic_calendars/physical_education/Annual-Activity-Calendar-2024-25.pdf')}}">Download PDF</a>
                    </div>
                </div>
            </div>
        </div>
