                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="row g-3">
                                <div class="col-12">
                                    <img src="{{asset('/assets/img/112.jpg')}}" class="img-fluid rounded" style="height: 250px; width: 100%;" alt="Property 1">
                                </div>
                                <div class="col-6">
                                    <img src="{{asset('/assets/img/112.jpg')}}" class="img-fluid rounded" style="height: 150px; width: 100%;" alt="Property 3">
                                </div>
                                <div class="col-6">
                                    <img src="{{asset('/assets/img/112.jpg')}}" class="img-fluid rounded" style="height: 150px; width: 100%;" alt="Property 4">
                                </div>
                            </div>
                        </div>
