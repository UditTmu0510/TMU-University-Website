					...
					<div class="col-sm-6">
						<div class="input-group form-group">
							<select class="required form-select" name="" id="">
								<option value="100">B.P.E.S. (Bachelor of Physical Education & Sports)</option>
								<option value="172">B.P.E.S with Research(Physical Education)</option>
								<option value="91">B.P.Ed. (Bachelor of Physical Education)</option>
								<option value="92">M.P.Ed. (Master of Physical Education)</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="container d-none d-sm-block">
							<div style="text-align:center">
								<iframe src="{{asset('assets/pdf/syllabus/BPES-001_2023-24.pdf')}}" frameborder="0" height="1000px" width="100%"></iframe>
							</div>
						</div>
						<div class="container d-block d-sm-none mb-3">
							<div style="text-align:center">
								<a href="{{asset('assets/pdf/syllabus/BPES-001_2023-24.pdf')}}" class="tmu-btn btn-4" download>Download PDF</a>
