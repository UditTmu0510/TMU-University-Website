                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2021-22.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_21_22.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2020-21.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_20_21.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2019-20.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_19_20.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2018-19.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_18_19.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2017-18.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_17_18.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
                    ...
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/placement_brochure/TMIMT/placement-brochure-2016-17.pdf')}}"
                                target="_blank"><img
                                    src="{{asset('/assets/img/placement_brochure/management/brochure_16_17.webp')}}" style="height: 100%; "
                                    alt="Book Cover Image"></a>
                        </div>
                    </div>
                    <div class="left-side">
