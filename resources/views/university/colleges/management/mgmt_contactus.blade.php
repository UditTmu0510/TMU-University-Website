    ...
    <div class="main-content">
        <div class="container">
            <div class="banner text-white text-center p-4 rounded" style="background-color: #001055;">
                ...
                <h3 class="text-white">For any query related to the College of Management, you may drop a message or contact
                    the
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <input type="hidden" name="cd_id" value="8" />
                    ...
                    <div class="col-md-6 d-flex flex-column align-items-center">
                        ...
                        alt="Chat bubbles with a telephone receiver on a blue background">
                        ...
                        <div class="contact-info w-100 mt-3">
                            <div>
                                ...
                                <div>
                                    <span>Email</span>
                                    <span class="text-break">principal.management@tmu.ac.in</span>
                                </div>
                            </div>
                            <div>
