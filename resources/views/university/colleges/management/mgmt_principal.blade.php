                        ...
                        <div class="col-md-10 mx-auto text-center">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="principal-image-wrapper23">
                                    <img src="{{asset('/assets/img/principal/management/management_principal.jpg')}}"
                                ...
                                <div class="principal-info23">
                                    <h4 class="principal-name23">Prof. (Dr.) Vipin Jain</h4>
                                    <p class="principal-position23">
                                        <!-- <i class="ph-bold ph-briefcase me-2"></i> -->
                                        <span> Director / Dean</span><br>

                                    </p>
                                    <!-- <span>Ph.D, FCMA, MBA(Gold Medalist), <br>LLB, CS(Executive)</span><br>
