                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                                <div class="card cab-members">
                                    ...
                                    <div class="card-body text-center"> <!-- Added 'text-center' class -->
                                        ...
                                        <p class="card-text fs-14 ">The Neotia University, West Bengal</p>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                                <div class="card cab-members">
                                    ...
                                    <div class="card-body text-center"> <!-- Added 'texmb-0t-center' class -->
                                        ...
                                        <p class="card-text fs-14">Principal & Deputy Nursing Director </p>
                                        <p class="card-text fs-14">Amrita College of Nursing, Amrita Hospital, Faridabad</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                                <div class="card cab-members">
                                    ...
                                    <div class="card-body text-center"> <!-- Added 'texmb-0t-center' class -->
                                        ...
                                        <p class="card-text fs-14 ">Director Nursing</p>
                                        <p class="card-text fs-14 ">Cloudnine Group of Hospitals</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                                <div class="card cab-members">
                                    ...
                                    <div class="card-body text-center"> <!-- Added 'texmb-0t-center' class -->
                                        ...
                                        <p class="card-text fs-14 ">Deputy Chief of Nursing</p>
                                        <p class="card-text fs-14 ">Fortis Hospital, South Delhi</p>
                                    </div>
                                </div>
                            </div>
                        </div>
