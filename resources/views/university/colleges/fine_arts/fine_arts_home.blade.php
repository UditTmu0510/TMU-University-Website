                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">BFA (Bachelor's of Fine Arts)</h4>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">MFA (Master's of Fine Arts)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        ...
                                        <div class="card-body progcardbody">
                                            ...
                                            <h5 class="mb-2">BFA (Bachelor's of Fine Arts)</h5>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                            </div>
                        ...
                        <div class="panel">
                            <ul class="progul">
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="images/stock_images/ccsit/2.jpg" height="178px">
                                        <div class="card-body progcardbody">
