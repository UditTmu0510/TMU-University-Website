                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                       <tr>
										...
										<td class="text-center">Mr. Ravindra Dev</td>
										<td class="text-center">Principal</td>
										<td class="text-center">9411970851</td>

									</tr>

									<tr>
										<td class="text-center">2</td>
										<td class="text-center">Dr. Farha Deeba</td>
										<td class="text-center">Assistant Professor </td>
										<td class="text-center">9045395032</td>
									...
									<tr>
										...
										<td class="text-center">Mr. Pravesh Chandra Verma</td>
										<td class="text-center">Assistant Professor </td>
										<td class="text-center">9336150676</td>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
									...
									<tr>
										<td class="text-center">3</td>
										<td class="text-center">Mr. Anup Kumar Pandey</td>
										<td class="text-center">Member</td>
										<td class="text-center">9873362133</td>
									</tr>

									<tr>
										<td class="text-center">4</td>
										<td class="text-center">Mr. Rajesh Kumar</td>
										<td class="text-center">First Information Person-I</td>
										<td class="text-center">9971913176</td>
									</tr>

									<tr>
										<td class="text-center">5</td>
										<td class="text-center">Mr. Vaibhav Jha</td>
										<td class="text-center">First Information Person-II</td>
										<td class="text-center">7523906969</td>
