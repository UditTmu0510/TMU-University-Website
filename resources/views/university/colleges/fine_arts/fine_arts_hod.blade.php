        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-lg-4 text-center img-container mb-4" style="height:fit-content;">
                    <img src="https://www.tmu.ac.in/img/tmu/administration/principal/fine_arts_principal_nivo.jpg"
                        alt="Tangade_dental_principal" height="fitcontent" width="450">
                </div>
                <div class="col-lg-8 col-sm-12">
                    <blockquote class="zitat1 my-3">
                        "Fine Arts is the study & making of visual works of art. It can be in the form of dancing,
                        paintings, photography, film, architecture, etc."
                        <!-- <cite>Peter Drucker</cite> -->
                    </blockquote>
                    <p class="mb-3">
                        It gives me great pleasure to see, the college make a prominent mark in the field of art
                        education and my students growing aesthetically, intellectually, culturally, and spiritually.
