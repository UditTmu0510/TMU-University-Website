        ...
        <div class="box d-none d-sm-block">
            ...
            <div class="container container-jnrl">
                ...
                <div class="book">
                    <div class="front">
                        <div class="cover">
                            <a href="{{asset('/assets/pdf/ccsit/event-magazine/Computing_Vision_Volume_10_issue_1.pdf')}}" target="_blank"><img
                                    src="{{asset('/assets/img/magazines/CCSIT/40.jpg')}}"
                            ...
                            <div class="main-book-wrap">
                                <div class="book-cover">
                                    ...
                                    <div class="book-image">
                                        <a href="{{asset('/assets/pdf/ccsit/event-magazine/Computing_Vision_Volume_10_issue_1.pdf')}}" target="_blank">
                                            <img src="{{asset('/assets/img/magazines/CCSIT/40.jpg')}}" />
                                        </a>
