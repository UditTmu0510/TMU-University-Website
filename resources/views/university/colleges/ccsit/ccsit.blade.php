            ...
            <div class="row ps-4">
                <div class="col-md-6 pt-0 pt-md-4 ps-md-5 mb-4">
                    ...
                    <a href="https://admissions.tmu.ac.in/" target="_blank"
                        class="tmu-btn btn-1 me-md-4 py-1 px-3 py-xl-2 px-xl-5 "> Apply Now</a>
                </div>
            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col-12 px-2 px-md-5">
                        <p style="text-align: justify;">The College of Computing Sciences & IT was established in 2014
                            (formerly
                            known as the Department of Computer Applications, established in 2001), is a leading private
                            computing sciences college in UP.</p>
                        <div class="read-more-content mt-0">
                            <p style="text-align: justify;">With a strong emphasis on emerging technologies such as
                                Artificial Intelligence (AI), Machine Learning (ML),
                                and Deep Learning (DL), the college equips students with the in-demand skills to thrive
                                in the rapidly evolving IT industry.
                                Beyond technical expertise, the CCS&IT also fosters an entrepreneurial mindset,
                                nurturing the next generation of innovators
                                and visionaries</p>
                            <p style="text-align: justify;">In today's digitally driven world, the demand for skilled
                                professionals in the field of computer sciences is
                                soaring higher than ever before. Amidst this surge, Teerthanker Mahaveer University's
                                College of Computing Sciences & IT
                                (CCSIT) stands out as a beacon of excellence, offering a comprehensive blend of academic
                                rigour and practical exposure.
                                Let's delve into why CCSIT at TMU is not just a college but a transformative journey for
                                aspiring IT enthusiasts.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="card card-sz shadow-sm">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/26.jpg')}}"
                                                    height="178px" class="card-img-top" alt="...">
                                                <div class="card-body">

                                                    <h5 class="mb-0 text-center">B.Com. (Fintech & Blockchain
                                                        Technologies with whizack
                                                        Technologies)</h5>
                                                </div>
                                                <div
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <!-- Card -->
                                            <div class="card card-sz shadow-sm">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/27.jpg')}}"
                                                    height="178px" class="card-img-top" alt="...">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="card card-sz shadow-sm progcard">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/28.jpg')}}"
                                                    height="178px" class="card-img-top" alt="...">
                ...
                <div class="container mb-5 mt-5">
                        ...
                        <ul class="progul">
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/9.jpg')}}"
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/34.jpg')}}"
                                        class="card-img-top" alt="...">
                                    <div class="card-body progcardbody">
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/13.jpg')}}"
                                        class="card-img-top" alt="...">
                                    <div class="card-body progcardbody">
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/5.jpg')}}"
                                        class="card-img-top" alt="...">
                                    <div class="card-body progcardbody">
                    ...
                    <div class="panel">
                        <ul class="progul">
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/19.jpg')}}" height="178px"
                            ...
                            <li class="progli">
                                ...
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/3.jpg')}}" height="178px">
                                    <div class="card-body progcardbody">
                            ...
                            <li class="progli">
                                ...
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/5.jpg')}}" height="178px">
                                    <div class="card-body progcardbody">
                ...
                <div class="marquee my-5 py-5 pt-4">
                    <section class="marquee-content">
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/face_academy.png')}}"
                                    alt="face academy visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/Tata%20Motors.png')}}"
                                    alt="Tata motors visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/Cetpa.png')}}"
                                    alt="cetpa visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/Tosha%20International.png')}}"
                                    alt="tosha inernational visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/tci.png')}}"
                                    alt="TCI visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/wipro.png')}}"
                                    alt="Wipro visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/torrent_gas.png')}}"
                                    alt="Torrent gas visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/munjal_auto.png')}}"
                                    alt="munjal auto visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/smart_brain.png')}}"
                                    alt="smart brain visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/infosys.png')}}"
                                    alt="infosys visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/ford-logo.png')}}"
                                    alt="ford visit TMU for recruitment"></a>
                        </div>
                        <div class="marquee-block">
                            <a href="#"><img src="{{asset('/assets/img/recruiters/ccsit/tech_mahindra.png')}}"
                                    alt="tech mahindra visit TMU for recruitment"></a>
                        </div>
                    </section>
                    <section class="marquee-content">
                        <div class="marquee-block">
...
<div class="container mb-5 mt-5">
    ...
    <button class="careers-accordion">Why Teerthanker Mahaveer University is the best choice for you:<span
            class="icon">+</span></button>
    <div class="panel">
        ...
        <p class="text-justify">Theory lays the foundation, but practical skills are the building blocks of success in
            the IT industry. CCSIT places a strong emphasis on hands-on learning, equipping students with the practical
            knowledge and skills demanded by today's dynamic IT landscape.</p>
        <h3 class="mb-1 tmu-color">100% Placement Assistance with an Excellent Track Record</h3>
        <p class="text-justify">For students, the ultimate goal of education is to secure a rewarding career. At CCSIT,
            we take pride in our track record of providing 100% placement assistance to our students, connecting them
            with leading companies in the industry and kickstarting their professional journey on the right note.</p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">

    <button class="careers-accordion">Strong Industry Connections with Top Companies at CCSIT<span
            class="icon">+</span></button>
    <div class="panel">
        <p>Networking is key in the IT world, and at CCSIT, we ensure that our students have access to top-notch
            industry connections. Collaborations with giants like IBM, Oracle, CISCO Networking Academy, and i Nurture
            open doors to endless opportunities for internships, projects, and placements.</p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">Professional Memberships and Global Career Prospects<span
            class="icon">+</span></button>
    <div class="panel">
        <p>Membership in esteemed organisations like IEEE, WIE, and the Computer Society of India Student Chapter not
            only adds value to a student's resume but also opens up a world of global career prospects. At CCSIT, we
            believe in empowering our students to thrive on both national and international platforms.</p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">On-Campus Hostel Facilities and Scholarship Assistance<span
            class="icon">+</span></button>
    <div class="panel">
        <p>We understand that a conducive living environment is essential for holistic growth. That's why CCSIT offers
            comfortable on-campus hostel facilities, ensuring that students feel at home even away from home.
            Additionally, our commitment to making quality education accessible is reflected in our 100% placement
            assistance.</p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    ...
    <div class="panel">
        <p>
            State-of-the-art classrooms, high-tech IT labs, and interactive learning environments are the hallmarks of
            CCSIT. We believe in providing our students with the best possible resources to facilitate their learning
            journey and prepare them for the challenges of the digital era.
        </p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">Vibrant Campus Life and Extracurricular Activities<span
            class="icon">+</span></button>
    <div class="panel">
        <p>Education is not just about academics; it's also about holistic development. CCSIT's vibrant campus life, IT
            clubs, sports championships, fitness centres, tech events, and workshops ensure that students have ample
            opportunities to explore their interests, showcase their talents, and make lifelong memories.
    ...
    <div class="panel">
        <p>The coveted AAA rating by Career 360 speaks volumes about CCSIT's commitment to academic excellence and
            student satisfaction. It's not just a rating; it's a testament to our relentless pursuit of excellence in
            education.
        </p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">TMU's Contribution to Innovation and Entrepreneurship<span
            class="icon">+</span></button>
    <div class="panel">
        <p>TMU's dedication to fostering innovation and entrepreneurship is evident through various initiatives like the
            Business Incubation Centre, Institution Innovation Council, and strategic partnerships with government
            bodies and industry stakeholders. These efforts are paving the way for a self-reliant India powered by
            innovation and entrepreneurship.
        </p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">Alignment with National Education Policy (NEP) 2020<span
            class="icon">+</span></button>
    <div class="panel">
        <p>TMU is at the forefront of educational reforms, aligning its practices with the vision of the National
            Education Policy (NEP) 2020. By embracing outcome-based education (OBE), redesigning the curriculum, and
            establishing industry-centric Centres of Excellence, TMU is shaping the future of education and preparing
    ...
    <div class="panel">
        <p>At CCSIT, campus life is vibrant and dynamic, offering students a plethora of opportunities to engage, learn,
            and grow. From bustling IT clubs to thrilling sports championships, there's never a dull moment on campus.
            Whether it's participating in tech events, attending workshops, or simply enjoying the camaraderie of fellow
            students, CCSIT's campus life is an enriching experience in itself.

        </p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">Facilities and Resources available at CCSIT, TMU<span
            class="icon">+</span></button>
    <div class="panel">
        <p>CCSIT boasts state-of-the-art facilities and resources designed to enhance the learning experience of
            students. Modern classrooms, well-equipped IT labs, and interactive learning spaces provide the perfect
            environment for academic exploration and innovation. Additionally, on-campus hostel facilities, fitness
            centers, cafeterias, and shopping stores ensure that students have everything they need for a comfortable
            and enriching stay at CCSIT.
        </p>
    </div>
    <!-- Add the horizontal line here -->
    <hr class="horizontal-line">
    <button class="careers-accordion">Career Opportunities in the Computer Science Field<span
            class="icon">+</span></button>
    <div class="panel">
        <p>The ultimate goal of education at CCSIT is to prepare students for successful careers in the IT industry.
            With 100% placement assistance, strong industry connections, and professional memberships, CCSIT opens doors
            to a world of career opportunities for its students. Whether it's securing internships, landing coveted job
            offers, or pursuing further studies, CCSIT equips students with the skills, knowledge, and confidence to
            excel in their chosen field.
        </p>
        <h3 class="mb-1 tmu-color">Conclusion</h3>
        <p class="text-justify">Teerthanker Mahaveer University's College of Computing Sciences & IT (CCSIT) is more
            than just a college; it's a gateway to endless opportunities, a hub of innovation, and a launchpad for
            aspiring IT professionals. Join us at CCSIT and embark on a journey of transformation, empowerment, and
            excellence in the dynamic world of computer sciences.</p>
        ...
        <p class="text-justify">Yes, CCSIT is UGC-approved and holds NAAC-A accreditation, ensuring quality education
            standards</p>
        <h5 class="tmu-color mb-0">2. What sets CCSIT apart from other colleges?</h5>
        <p class="text-justify">CCSIT offers a unique blend of academic excellence, practical exposure, industry
            connections, and vibrant campus life, setting it apart as a top choice for computer science education.</p>
        <h5 class="tmu-color mb-0">3. Does CCSIT offer hostel facilities?</h5>
        <p class="text-justify">Yes, CCSIT provides on-campus hostel facilities to ensure a comfortable living
            environment for students.</p>
        <h5 class="tmu-color mb-0">4. How does CCSIT support students in their career aspirations?</h5>
        <p class="text-justify">CCSIT offers 100% placement assistance, strong industry connections, and professional
            memberships, paving the way for successful careers in the IT industry.</p>
        <h5 class="tmu-color mb-0">5. What specialisations are available at CCSIT?</h5>
        <p class="text-justify">CCSIT offers a wide range of core programmes including BTech, MTech, BCA, MCA, and BSc,
            catering to diverse interests and career goals.</p>
        <h5 class="tmu-color mb-0">6. Which institute is best for computer science in India?</h5>
        <p class="text-justify">There are thousands of institutes for computer science in India. The choice of the best
            institute varies from person to person based on their expectations, locations, fees, placement, hostels and
            other criteria.</p>
        ...
        <p class="text-justify">There are many good private colleges for CSE, out of them CCSIT, Teerthanker Mahaveer
            University is one of the top private colleges for CSE placement.</p>
        <h5 class="tmu-color mb-0">9. Is India good for CS?</h5>
        <p class="text-justify">India is good for CS as there are thousands of multinational IT companies and huge job
            opportunities.</p>
        <h5 class="tmu-color mb-0">10. Who is India's No. 1 college?</h5>
        <p class="text-justify">There are thousands of colleges in India. The choice of the best college varies from
            person to person based on their expectations, locations, fees, placement, hostels and other criteria.</p>
