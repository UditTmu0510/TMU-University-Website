                ...
                <div class="col-12 col-md-6">
                    <div class="pe-lg-4 position-relative p-0">
                        <div style="z-index: 2;">
                            ...
                            <img src="{{asset('assets/img/banner/ccsit/ccsit-banner.png')}}" alt="" class="p-0 m-0">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="card card-sz shadow-sm">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/26.jpg')}}" height="178px"
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <!-- Card -->
                                            <div class="card card-sz shadow-sm">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/27.jpg')}}" height="178px"
                                                    class="card-img-top" alt="...">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="card card-sz shadow-sm progcard">
                                                <img src="{{asset('assets/img/programme_stock_img/medical/28.jpg')}}" height="178px"
                                                    class="card-img-top" alt="...">
                ...
                <div class="container mb-5 mt-5">
                    ...
                    <div class="panel">
                        <ul class="progul">
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/34.jpg')}}" class="card-img-top"
                                        alt="...">
                                    <div class="card-body progcardbody">
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/13.jpg')}}" class="card-img-top"
                                        alt="...">
                                    <div class="card-body progcardbody">
                            ...
                            <li class="progli">
                                <div class="card shadow-sm progcard">
                                    <img src="{{asset('assets/img/programme_stock_img/medical/5.jpg')}}" class="card-img-top"
                                        alt="...">
                                    <div class="card-body progcardbody">
