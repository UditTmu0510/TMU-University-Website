            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <input type="hidden" name="cd_id" value="7" />
                ...
                <div class="col-md-6 d-flex flex-column align-items-center">
                    ...
                    <div class="contact-info w-100 mt-3">
                        <div>
                            ...
                            <div>
                                <span>Email</span>
                                <span class="text-break">principal.physiotherapy@tmu.ac.in</span>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="contact-info w-100 mt-3">
                        <h5 class="tmu-text-primary"><span> Working </span><span> Hours</span></h5>
                        <div>
                            <!-- <img src="email-icon.png" alt="Email Icon"> -->
                            <div>
