        ...
        <section class="about-section bg-light mt-4">
            <div class="container">
                <div class="text-content p-4">
                    <h1 class="tmu-text-primary tmu-page-heading"><span>Welcome to the </span><span> Department of Physiotherapy </span></h1>
                ...
                <div class="container p-3">
                    ...
                    <p class="about-p mb-4">For theoretical knowledge, a well-stocked central library serves as a valuable resource. The curriculum's practical component finds fulfilment through engaging work in laboratories. TMU offers BPT/MPT/PhD programme's. Thus, assuring students of the program's credibility and recognition. As a result, the best Physiotherapy Department in UP equips students with comprehensive knowledge, preparing them to become skilled professionals in the field. This contributes significantly to the healthcare sector.</p>
                </div>
            </div>
        </section>
