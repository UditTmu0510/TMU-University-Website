...
<div class="main-content">
    <div class="container">
        ...
        <div class="col-md-12">
            <h1 class="tmu-text-primary tmu-page-heading mb-3 mt-md-3"><span>Community</span><span> Health Centers</span></h1>
        </div>
                ...
                <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
                    ...
                    <div class="team-desc p-2">
                        <div class="team-title pt-0">
                            <h4 class="fs-14">Community Health Centre</h4><span class="fst-normal fs-12 mb-2"
