...
<div id="slider" class="slideshow-container">
    ...
    <div class="text d-none d-sm-block" style="color: #000000;">
        ...
        <a href="https://admissions.tmu.ac.in/" class="tmu-btn btn-4 px-3 py-1 px-lg-5 py-lg-2 ms-5">Apply Now</a>
        @endif
    </div>
</div>
@endif
...
<div class="banner d-block d-sm-none">
    <!-- Image Div -->
    <div class="ban-image">
        <img src="{{ asset($programme_brochure_path) }}" alt="Programme Brochure" class="cropped-image img-fluid w-100">
    </div>
...
<div class="container mt-2">
    <div class="row justify-content-center ">
        <div class="col-xl-10 col-lg-10 text-center d-none d-sm-block">
            <h2 class="tmu-text-primary fs-26 mb-0 pb-0"><span>About</span> <span>{{$programme->prog_name}}</span></h2>
        </div>
...
<div class="container">
    <div class="row justify-content-center ">
        <div class="col-xl-10 col-lg-10 text-center mt-4">
            <h2 class="tmu-text-primary fs-26 mb-0 pb-0"><span>Fee Structure for </span><span>{{$programme->prog_name}}</span></h2>
    ...
    <div class="container" style="margin-top: 12px; margin-bottom: 8px;">
        ...
        <div class="row align-items-lg-center min-vh-lg-100">
            ...
            <div class="col-lg-6 align-self-center">
                <h2 class="tmu-text-primary mb-3 fs-26 lh-sm mt-4 mb-0 pb-0"> <span>{{$programme->prog_name}}</span><span> Eligibility Criteria & Selection Process </span></h2>
                <div class="row">
                    <div class="col-sm-6">
...
<section class="my-5">
    <div class="container">
        <h2 class="tmu-text-primary text-center fs-26"><span> Frequently </span><span> Asked Questions</span></h2>
