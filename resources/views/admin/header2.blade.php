...
{{-- 
     <div v-if="results.length > 0" class="autocomplete-results">
      <ul>
          <li v-for="(result, index) in results" :key="index">
              <a href="https://www.tmu.ac.in/" target="_blank" class="result-link">
                  <span class="result-title">@{{ result.meta_title }}</span>
                  <!-- Add additional information here if available, e.g., result.description -->
              </a>
          </li>
      </ul>
  </div> --}}
