...
<td>
  ...
  <a href="{{route('edit.news_category',$item->id)}}" class="btn btn-primary">Edit</a>
@endif
</td>
<td>
  @if(Auth::user()->can('Delete Permission'))
<a href="{{route('delete.news_category',$item->id)}}" class="btn btn-danger">Delete</a>
  @endif
</td>                                                                                                                                                                           
                </tr>
@php
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <!-- Code Start -->
            <form  method="POST" action="{{route('add.news_category')}}" class="row g-3">
                @csrf
