        ...
        <div class="card-body">
          ...
          <div class="col-md-2">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-3">
                <label for="schema_markup" class="col-form-label">Schema Markup</label>
                <input type="text" name="schema_markup" id="schema_markup" class="form-control" value="{{$meta->schema_markup}}" />
              </div>

              
              <div class="col-md-3">
                <label for="no_index_status" class="form-label">No Index Status</label>
                <select class="form-select" name="no_index_status" id="no_index_status" required>
                  <option value="" disabled>No Index Page</option>
                  <option value="Y" {{ old('no_index_status', $meta->no_index_status) == 'Y' ? 'selected' : '' }}>Yes</option>
                  <option value="N" {{ old('no_index_status', $meta->no_index_status) == 'N' ? 'selected' : '' }}>No</option>
                </select>
              </div>
