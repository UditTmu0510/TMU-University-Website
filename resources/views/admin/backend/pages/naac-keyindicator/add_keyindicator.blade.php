...
<div class="pagetitle">
    <h1>Add Key Indicator</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Key Indicator</a></li>
        {{-- <li class="breadcrumb-item">Permission</li> --}}
        <li class="breadcrumb-item active">Add Key Indicator</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
...
@endif
    ...
    <div class="card-body">
      ...
      <!-- Multi Columns Form -->
      <form  method="POST" action="{{route('add.naac_keyindicator')}}" enctype="multipart/form-data" >
        @csrf
...
<option value="{{$criterion->criterion_id}}">{{$criterion->criterion_name}}</option>
            ...
            <div class="col-md-4">
                <label for="key_indicator_name" class="form-label" style="font-size:13px;">KeyIndicator Name</label>
                    <input type="text" name="key_indicator_name" id="key_indicator_name" class="form-control" required />
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="key_indicator_description" id="key_indicator_description" class="form-control" required />
        </div>
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-6"> 
        ...
        <input class="form-control" type="number" name="key_indicator_priority" id="key_indicator_priority"  value="{{$priority}}" required />
      </div>
        ...
        <div class="text-center"><br/>
          <input type="submit" class="btn btn-primary" value="Add KeyIndicator" id="myButton"  />
