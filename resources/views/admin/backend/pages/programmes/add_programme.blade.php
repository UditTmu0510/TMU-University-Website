...
@section('content')
                            ...
                            <div class="row" style="margin-top:30px;">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="prog_duration_with_intersnhip"
                                        id="prog_duration_with_intersnhip" class="form-control" required />
                                </div>
                    ...
                    <input type="file" class="form-control dropify" name="ti_path" id="ti_path"  required />
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="prog_duration_without_intersnhip"
                                        id="prog_duration_without_intersnhip" class="form-control" required />
                                </div>

                                <div class="col-md-2">
                                    <label for="prog_duration_type_without_internship" class="form-label">Duration Type
                                        (Without Intersnhip)</label>
                                ...
                                <div class="col-md-2">
                                    <label for="prog_duration_type_with_internship" class="form-label">Duration
                                        Type(Internship)</label>
  ...
  <textarea rows="4" cols="50" name="area"  id="area" ></textarea><span class="highlight"></span> <span class="bar"></span>
                                            ...
                                            <table class="table color-table success-table" id="dynamic_field">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="fee_description[]"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control dropify" name="programme_image_path"
                                        id="programme_image_path" type="file" required />
                                    <br />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control dropify" name="programme_banner_path"
                                        id="programme_banner_path" type="file"><br />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control dropify" name="programme_brochure_path"
                                        id="programme_brochure_path" type="file">
                                    <br />
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <label for="programme_by_qualification" class="form-label">Programme By
                                        Qualification</label>
                                ...
                                <div class="col-md-4">
                                    <label for="programme_by_discipline" class="form-label">Programme By
                                        Discipline</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="programme_by_category" name="programme_by_category"
                                        ...
                                        <option value="Certificate / Diploma Programme">Certificate / Diploma Programme
                                        </option>
