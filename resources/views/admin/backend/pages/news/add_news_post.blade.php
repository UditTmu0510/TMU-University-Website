...
<div class="row mt-3">
          <div class="col-md-3">
            <label for="ti_path" class="col-form-label">All News Page Image</label>
                  <div class="col-sm-10">
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="title_image_tag" class="form-control" id="title_image_tag" required />
          </div>
          ...
          <div class="col-md-3">
            ...
            <select class="form-select" name="category" id = "category" aria-label="Default select example" required>
              ...
              <option value="{{$news_cat->category_name}}">{{$news_cat->category_name}}</option>
              @endforeach
            </select>
          </div>
    ...
    <div class="row mt-3">
      <div class="col-md-4">
        <label for="ei1_path" class="col-form-label">Event Image 1</label>
                <input class="form-control dropify" name="ei1_path" id="ei1_path" type="file" required />
                <br/>
                <input class="form-control" name="event_image1_tag" id="event_image1_tag" type="text" placeholder="Alt Tag" required />
      </div>

      <div class="col-md-4">
        <label for="ei2_path" class="col-form-label">Event Image 2</label>
                <input class="form-control dropify" name="ei2_path" id="ei2_path" type="file" ><br/>
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4">
            <label for="ei2_full_path" class="col-form-label">Event Image 5</label>
                    <input class="form-control dropify" name="ei5_path" id="ei5_path" type="file" ><br/>
          ...
          <div class="col-md-4">
            <label for="ei3_full_path" class="col-form-label">Event Image 6</label>
                    <input class="form-control dropify" name="ei6_path" id="ei6_path" type="file" ><br/>
                  ...
                  <div class="row mt-3">
          <div class="col-md-4">
            <label for="monaco_image_path" class="col-form-label">University Home Page Image</label>
