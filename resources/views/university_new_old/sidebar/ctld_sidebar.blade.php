<div class="main-sidebar" id="main-sidebar">
    ...
    <div class="custom-menu-section">
        ...
        <div class="account-section">
            <a href="{{route('ctld.about')}}" class="custom-menu-item active">
                <p>Overview</p>
            </a>
            <a href="{{route('ctld.aims.and.objectives')}}" class="custom-menu-item">
                <p>Aims & Objective</p>
            </a>
            <a href="{{route('ctld.director.desk')}}" class="custom-menu-item">
                <p>Director's Desk</p>
            </a>
            <a href="{{route('ctld.team')}}" class="custom-menu-item">
                <p>Our Team</p>
            </a>
        </div>
        <h2>Testimonials</h2>
        <div class="account-section">
            <a href="{{route('ctld.students.testimonials')}}" class="custom-menu-item">
