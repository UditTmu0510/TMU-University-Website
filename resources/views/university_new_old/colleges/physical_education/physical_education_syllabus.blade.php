                            ...
                            <div class="form-widget card-body"  data-alert-type="inline">
									...
									<form id="form-cleaning" name="form-cleaning" action="include/form.php" method="post" class="row form-cleaning mt-2">
										...
										<object data="assets/pdf/BTECH-001_2023-24.pdf" type="application/pdf" width="100%" height="1150px">
		                					...
		                					<center><a type="button" class="tmu-btn btn-1 btn-lg btn-rounded text-lg waves-effect waves-light" href="assets/pdf/BTECH-001_2023-24.pdf" download type="assets/pdf/BSC-Anatom_2022-23.pdf"><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
	                					</object>
                                        </div>
									</form>
								</div>
