            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="https://www.tmu.ac.in/pdf/medical/Anatomy.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="https://www.tmu.ac.in/pdf/medical/Physiology.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="https://www.tmu.ac.in/pdf/medical/Biochemistry.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="https://www.tmu.ac.in/pdf/medical/Pathology.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <i class="fas fa-file-pdf fa-4x mb-3" style="color:#FF7900; "></i>
                            <h5 class="card-title">Forensic Medicine</h5>
                            <a href="https://www.tmu.ac.in/pdf/medical/Pathology.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <i class="fas fa-file-pdf fa-4x mb-3" style="color:#FF7900; "></i>
                            <h5 class="card-title">Community Medicine</h5>
                            <a href="https://www.tmu.ac.in/pdf/medical/Pathology.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <i class="fas fa-file-pdf fa-4x mb-3" style="color:#FF7900; "></i>
                            <h5 class="card-title">Pulmonary Medicine</h5>
                            <a href="https://www.tmu.ac.in/pdf/medical/Pathology.pdf"
                                class="more-link fst-normal ms-2 fs-12">View pdf <i class="bi-arrow-right"></i></a>
                        </div>
                    </div>
