                ...
                <div class="entry event col-lg-4 col-md-6 col-sm-6 ">
                    <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow card border">
                        ...
                        <div class="entry-meta mb-1">
                            <ul>
                                <li><span class="badge bg-warning text-dark py-1 px-2"><i class="uil-calendar-alt"></i>February 06<sup>th</sup>, 2020</span></li>
                            </ul>
                        </div>
                        <div class="entry-title title-sm ">
                            <h3 class="tmu-text-primary fs-16"><span>Guest Lecture on importance of MOOCS & SWAYAM </span></h3>
                        </div>
