                    ...
                    <div class="col-sm-6">
                        <div class="input-group form-group">
                            <select class="required form-select" name="" id="">
                                <option value="88">B.A.-B.Ed.(Integrated)</option>
                                <option value="87">B.Sc.-B.Ed.(Integrated)</option>
                                <option value="86">B.El.Ed.</option>
                                <option value="85">B.Ed. (Bachelor of Education)</option>
                                <option value="89">M.Ed. (Master of Education)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="container d-none d-sm-block">
                            <div style="text-align:center">
                                <iframe src="https://www.tmu.ac.in/pdf/syllabus/INT-002_2023-24.pdf" frameborder="0" height="700px" width="100%"></iframe>
                            </div>
                        </div>
                        <div class="container d-block d-sm-none mb-3">
                            <div style="text-align:center" class="mt-sm-5">
                                <a href="https://www.tmu.ac.in/pdf/syllabus/INT-002_2023-24.pdf" class="tmu-btn btn-4" download>Download PDF</a>
                            </div>
                        </div>
                    </div>
                </form>
