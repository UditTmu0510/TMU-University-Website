    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center img-container">
                <img src="{{asset('/assets/img/principal/physical_education/physicaleducation_principal.jpg')}}"
            ...
            <div class="col-md-12">
                <p class="mb-3">   Then they are ready to take up a significant role in building a Healthy India and a Healthy World. We welcome you to the College of Physical Education and wish you the best in great learning for a healthy and rewarding life.</p>
                <div class="person-details">Prof. Manu Mishra <br>
                    <span> Principal</span>
                </div>
