                    ...
                    <form id="form-cleaning" name="form-cleaning" action="include/form.php" method="post"
                        ...
                        <div class="col-sm-6">
											<div class="input-group form-group">
                                                ...
                                                <option value="83">BFA (Bachelor of Fine Arts)</option>
						                        <option value="84">MFA (Master of Fine Arts)</option>
											</select>
											</div>
										</div>
                        ...
                        <div class="col-md-12">
                            <div class="container d-none d-sm-block">
                                <div style="text-align:center">
                                    <iframe src="https://www.tmu.ac.in/pdf/syllabus/BFA-001_2023-24.pdf" frameborder="0"
                                        height="700px" width="100%"></iframe>
                                </div>
                            </div>
                            <div class="container d-block d-sm-none mb-3">
                                <div style="text-align:center" class="mt-sm-5">
                                    <a href="https://www.tmu.ac.in/pdf/syllabus/BFA-001_2023-24.pdf"
