  ...
  <div class="row mx-0">
    ...
    <ol class="ps-5">
      ...
      <ul class="m-ol-list ps-4 mb-3">
        ...
        <li>Ensuring friendly environment in the College/Department by promoting cordial Student-Student and Student-Staff relations.</li>
    ...
    <ol class="ps-5 mb-3">
      ...
      <div class="table-responsive mb-3">
        <table class="table table-bordered table-striped">
          <tbody>
            ...
            <tr>
              <td>(iv)</td>
              <td>Dy. Registrar/Asstt. Registrar/Administrative Officer
                <br>OR
                <br>A person not below the rank of an Asstt. Professor (to be nominated by the Principal)
              </td>
              <td>:</td>
      ...
      <li><b>For Independent Teaching Departments</b></li>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>One Senior most Professor <br>
                (In case there is no Professor, the senior most faculty other than mentioned below)</td>
              <td>:</td>
              <td>Member</td>
            </tr>
            <tr>
    ...
    <ol class="ps-5 m-ol-list mb-3">
      ...
      <li>A student can approach the Students’ Help Desk for any grievance/suggestion related to other sections of the University, or regarding a grievance not settled by her/his College/Department.</li>
      <li>A student can also make use of the Suggestion/Complaint Box maintained at the Students’ Help Desk for giving a suggestion or reporting a grievance.</li>
      <li>No student is allowed to file a grievance/suggestion on behalf of any other student.</li>
    ...
    <ol class="ps-5 m-ol-list">
      ...
      <li>The Suggestions/Grievances so received shall be entered in serial order with a suffix S or G, as the case may, in the register maintained for the purpose. All grievances/ suggestions received by hand or email shall also be recorded in the same register in the order of their receipt at the concerned Cell/Desk.</li>
      <li>The Students Grievance Redressal Cell shall ensure urgent meeting(s) as are necessary to ensure early resolution of grievance(s), such that the students can find early solution to the difficulties faced by them, thus generating higher confidence into the system.</li>
      <li>It is desirable that the ‘Cell’ resolves all the issues within seven working days from date of its registering.</li>
      <li>The action taken with date against each grievance/suggestion shall be recorded in the above register.</li>
      <li>Minutes of meeting of the ‘Cell’ shall be maintained by the respective College/ Department.</li>
