...
<div class="col-12 col-md-10 mt-3 mt-sm-0 pt-2">
    <div class="container">
        <div class="row">
            <h1 class="tmu-text-primary tmu-page-heading"><span> Chancellor </span>
                <span> Desk</span>
            </h1>

            <div class="col-md-4 text-center mb-3 img-container">
                <img src="{{asset('assets/image/chancellor-image.png')}}" class="w-100" alt="">
            </div>
            <div class="col-md-8">
                <p class="person-quote px-4 px-md-5">
                    ...
                    lifestyle.<br>
                    The multidisciplinary approach of our curriculum focuses on <span class="highlight">experiential learning</span>, leveraging of <span class="highlight">ICT for better content delivery</span>, and provisions for
                    ...
                    dedicated faculty of this prestigious University, they shall be able to <span class="highlight">take full advantage of opportunities offered to them</span>.
