...
<div class="col-12 col-md-9 col-lg-10 mt-3 mt-sm-0 pt-3 pt-md-5 px-4">
    <div class="container">
        <div class="row">
            <h2 class="tmu-text-primary tmu-page-heading"><span>Founder Vice </span> <span>Chancellor Desk</span></h2>
            ...
            <div class="col-md-8">
                <p class="person-quote px-4 px-md-5">
                    ...
                    creative and enthusiastic youth of the country into the <span class="highlight">nation building process</span>. I strongly believe that right
                    mix of education focusing on <span class="highlight">head, heart and hand</span> can
                    substantially help in meeting this challenge. The need therefore is to <span class="highlight">reorient education</span> that concentrates on the development
                    ...
                    started yielding satisfactory results whereby in the last one year <span class="highlight">210 quality research papers have been published</span>. We are
