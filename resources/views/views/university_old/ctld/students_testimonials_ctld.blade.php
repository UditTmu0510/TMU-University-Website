    ...
    <div class="container tmu-testimonial mt-5 mb-3">
        <div class="row">
            <div class="oc-item text-start col-md-4">
                <div class="media ">
                    <img src="https://www.tmu.ac.in/uploads/testimonial/Manali_Jain.jpg" class="mr-3" alt="">
            ...
            <div class="oc-item text-start col-md-4">
                <div class="media">
                    <img src="https://www.tmu.ac.in/uploads/testimonial/Kanika_Kapoor.jpg" class="mr-3" alt="">
                    <div class="media-body">
                        <div class="testimonial">
            ...
            <div class="oc-item text-start col-md-4">
                <div class="media">
                    <img src="https://www.tmu.ac.in/uploads/testimonial/Website_Photos_(Testimonial).jpg" class="mr-3" alt="">
                    <div class="media-body">
                        <div class="testimonial">
