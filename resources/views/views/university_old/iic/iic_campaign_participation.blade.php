...
<div class="col-12 col-md-9 col-lg-10 mt-3 mt-sm-0 pt-3 pt-md-5 px-4">
    ...
    <div class="row mx-0">
        <h1 class="tmu-text-primary tmu-page-heading"><span>Campaign</span> <span>Participation</span></h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 p-4" style="box-sizing:border-box;">
                    <img src="https://www.tmu.ac.in/img/coe/11 july Indias First Leadership Talk Series-certification Patcher - Session with General Dr. Madhuri Kanitkar_page-0001.jpg" alt="">
                </div>
