...
<div class="col-12 col-md-9 col-lg-10 mt-3 mt-sm-0 pt-5">
  <div class="row mx-0">
    <h1 class="tmu-text-primary tmu-page-heading"><span>Water Conservation</span> <span>Initiatives</span></h1>
    <div class="container mb-5 mt-5">
      <hr class="horizontal-line">
      <button class="careers-accordion clicked"> Rainwater Harvesting<span class="icon">+</span></button>
      ...
      <div class="panel">
        ...
        <h3 class="tmu-text-primary">Demand of Water</h3>
        ...
        <h3 class="tmu-text-primary">Water Treatment by (1.5 MLD) S.T.P. </strong></h3>
        <p>Waste Water Generation is 80% of Total Supply = 1068000 Lt./Day.</p>

        <h3 class="tmu-text-primary">Treated Water Used</h3>
        <p>
        <ul class="m-ol-list ps-4">
          <li>In Horticulture : 600000 Lt./Day</li>
          <li>In Agriculture : 400000 Lt./Day</li>
        </ul>
        </p>

        <h3 class="tmu-text-primary">Note</h3>
        <ul class="m-ol-list ps-4">
          <li>Usage of Water is Variable <b>(Due to different Weather Condition)</b>.</li>
          <li>The variation of used treated water is maintained through reservoir of capacity 1Cr. Lt.</li>
        </ul>
      </div>
      <hr class="horizontal-line">
    </div>
