<div class="col-sm-3 col-lg-2 sticky-sidebar-wrap pe-5 py-0 py-lg-3 " style="background-color: #55555510;">
	...
	<ul class="list-unstyled items-nav sticky-sidebar shop-filter mt-4 d-none d-sm-block" data-container="#shop">
		...
		<li class="no-divider"><a href="{{route('naac.home')}}" class="text-dark fw-semibold side-head" data-filter=".sf-new">Cycle-II</a></li>
		<li class="no-divider"><a href="{{route('naac.cycle.i')}}" class="text-dark fw-semibold side-head" data-filter=".sf-new">Cycle-I</a></li>
	</ul>
