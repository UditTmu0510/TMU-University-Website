					...
					<li class="text-justify"><b>Rules and Code of Conduct</b>
						<ul style="list-style:circle">
							<li class="text-justify">Transparency, fairness and equal opportunity for all students are the
								hallmarks of the placement process at the University.</li>
							<li class="text-justify">Whenever a company proposes a visit to the University Campus, it sends a
								letter of confirmation about the date of the interview, which would be displayed on the notice board as
							...
							<li class="text-justify">Once a student gets shortlisted by the company for going through the
							...
							<li class="text-justify">Students appearing for placement are expected to report at the time given
								and come well prepared by going through relevant literature such as the company website, company's
								...
								<ul style="list-style-type:disc" class="pt-0 mt-0 ps-0">
									...
									<li style="text-align:justify; margin-left:30px;"><b>For Ladies:</b> Neat and ironed clothes, well-groomed appearance. Sari/ Business Suit/ Salwar- Kameez, Leather Sandals/Shoes</li>
									...
									<li style="text-align:justify; margin-left:30px;">Requirements of the company will be taken care of
										...
										MAHAVEER a long distance and any kind of communication to be sent has to
										be directed through the Incharge (Training &amp; Placement).</li>
									...
									<li style="text-align:justify; margin-left:30px;">Students are advised to abide by the final short
										...
										queries from students should be aimed at clarifying job profiles, compensation etc.</li>
					...
					<li class="text-justify"><b>Placement Assistance</b>
						<ul style="list-style:circle">
							...
							<li class="text-justify">The major components of the placement (summer or final) process are
								...
								reading, especially of financial and general newspapers besides study of the course curriculum and
							...
							<li class="text-justify">Please remember that companies are looking for proactive, energetic,
								...
								University. The recruiter needs to sense the "hunger" for the job on offer to the candidate.</li>
							<li class="text-justify">University will encourage and assist all students to emerge as credible
								brands in their own right who are sought after by the company.</li>
							<li class="text-justify">The entire placement process gets executed as per a detailed <b>Action
									Plan</b> prepared in advance at different College levels in joint consultation with the University
