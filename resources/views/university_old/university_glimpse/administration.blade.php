...
<h1 class="tmu-text-primary tmu-page-heading"><span>University</span><span> Administration</span></h1>
          <div class="container">
            <div class="row row-cols-1 row-cols-md-3 g-4 mt-5">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation">
                  <img src="https://www.tmu.ac.in/img/tmu/administration/p(vkj.jpg" class="card-img-top" alt="Image 1">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation">
                  <img src="https://www.tmu.ac.in/img/tmu/administration/daks1.jpg" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card card-animation">
                  <img src="https://www.tmu.ac.in/img/tmu/administration/pmj.jpg" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
