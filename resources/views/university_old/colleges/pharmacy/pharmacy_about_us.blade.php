        ...
        <section class="about-section bg-light mt-4">
            <div class="container">
                <div class="text-content p-4">
                    ...
                    <p class="about-p mb-4">The College of Pharmacy was established in the year 2008. The college grooms professionals by providing diplomas and undergraduate, post-graduate and doctorate level programs, equipping the students with innovative techniques to resolve problems in drug industries and clinical areas.</p>
                </div>
