        ...
        <section class="about-section bg-light mt-4">
            <div class="container">
                <div class="text-content p-4">
                    <h1 class="tmu-text-primary tmu-page-heading"><span>Department of </span><span>General Medicine </span></h1>
                    ...
                    <div class="image-content text-center p-4">
                        <img src="{{asset('/assets/img/college_departments/medical/generalmedicine/21.jpg')}}" alt="Learning and Teaching">
                    </div>
            ...
            <div class="col-md-12 text-center p-2 mt-0">
                <a class="tmu-btn btn-2 m-0 py-1 px-2 fs-12" href="{{route('medical.general.medicine.infra')}}" target="_blank"> Click here to view Geo Tagged Infrastructure</a>
            </div>
        </section>
    </div>
</div>
