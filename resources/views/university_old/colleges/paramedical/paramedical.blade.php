...
<div class="box-container">
    <div class="box">
        <h2 Class="h2-line" style="font-weight: 800;">Welcome to the College of Paramedical Sciences</h2>
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10 col-sm-10">
                <p style="text-align: justify;">The College of Paramedical Sciences, established in 2010, is a leading
                    college in India offering BSc, MSc, and PhD programmes in Paramedical Science. Our primary aim is to
                    train Paramedical Science professionals, contributing to the medical field. Students gain real-world
                    experience through clinical exposure at our parent hospital. Being recognised as the Best
                    Paramedical Science College in UP, we take deep pride in our unwavering dedication to
                    excellence.<br>
                    <a href="#" class="button button-3d button-medium button rounded-pill button-blue"
                        style="margin-top: 20px;">Know More!</a>
                </p>
            </div>
            <div class="col-md-1"></div>
    ...
    <section class="marquee-content">
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
                    src="https://cdn.shopify.com/s/files/1/0789/1333/files/Forbes.svg?v=1593719066" alt="Forbes"></a>
        </div>
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
        ...
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
                    src="https://cdn.shopify.com/s/files/1/0789/1333/files/Nat_Geo.svg?v=1593719066" alt="Nat Geo"></a>
        </div>
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
        ...
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
                    src="https://cdn.shopify.com/s/files/1/0789/1333/files/Fortune.svg?v=1593719066" alt="Fortune"></a>
        </div>
        <div class="marquee-block">
            <a class="marquee-logo" href="#"><img
                    src="https://cdn.shopify.com/s/files/1/0789/1333/files/Discovery_Channel.svg?v=1593719066"
