                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Electrically operated Dental Chairs with shadowless lamp, spittoon, 3 way syringe, instrument tray and motorized
                                    suction, micromotor, airotor attachment with hand pieces</td>
                            </tr>
                            <tr>
                                <td class="text-center" sdval="2">2</td>
                                <td>ENDOSONIC HANDPIECES &ndash; Micro endosonic Tips, retro treatment</td>
                            </tr>
                            <tr>
                                <td class="text-center" sdval="3">3</td>
                                <td>Mechanised rotary instruments including hand pieces (speed and torque control) and hand instruments various
                                    systems</td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Equipments for ceramics including induction casting machines/ burnout preheat furnaces/ wax elimination furnaces
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center" sdval="31">31</td>
                                <td>Lab micro motor/ metal grinders / sand blasters/ polishing lathes/ duplicator equipment/ vacuum investment
                                    equipments</td>
                            </tr>
                            <tr>
