            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="section-box p-3">
                        ...
                        <p>
                        "The Vision of TMIMT College of Physical Education is to see a World where all individuals have the opportunity to live healthy lives in Body, Mind and Spirit"                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-box p-3">
                        ...
                        <p>
                        "The Mission is to educate students in body, mind and spirit, to enhance the leadership in service to humanity by building upon the foundation of humanists, academic excellence and value-based education"                        </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="section-box p-3">
                        ...
                        <ol class="m-ol-list ps-5 mb-3">
                            ...
                            <li>Books – 3480, Journals – 06, Hobby Books – 2600, Total Titles – 1662</li>
                            <li>Placement Cell (100% Placement)</li>
                            <li>School Teaching Practice Exposure</li>
                            <li>Eminent Teaching Faculty</li>
                        </ol>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="section-box p-3">
                        ...
                        <ol class="m-ol-list ps-5 mb-3">
                            ...
                            <li>Summer Camp</li>
                            <li>Sports Meets, Officiating Exposure</li>
                        </ol>
                    </div>
                </div>
            </div>
