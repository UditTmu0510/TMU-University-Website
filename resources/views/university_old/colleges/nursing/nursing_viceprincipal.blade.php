        ...
        <div class="">
            ...
            <div class="quote-box mx-auto">
                <div class="profile-image mb-2">
                    <img src="{{asset('/assets/img/principal/nursing/tmns_head.jpg')}}" alt="Profile Image">
                </div>
                <div class="quote-text mt-4 mt-md-0">
                    ...
                    <p class="text-justify text-dark fs-14 mb-2">As Principal of the esteemed Teerthanker Mahaveer College of Nursing, I would like to take a moment to address all of you and express my heartfelt gratitude for your unwavering dedication and commitment to excellence.</p>
