            ...
            <div class="main-content mt-3 mt-sm-0 pt-2 pt-sm-5">
                <div class="container">
                    <div class="row justify-content-center gutter-10" data-lightbox="gallery">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/3.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/4.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/5.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/6.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/7.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/8.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/9.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/10.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/11.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/12.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/13.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/14.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/15.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/16.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/17.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/18.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/19.webp')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                                        <a href="{{asset('/assets/img/gallery/collegegallery/physiotherapy/19.webp')}}"
                                            class="overlay-trigger-icon size-sm bg-light text-dark"
                                            data-hover-animate="fadeInDownSmall"
                                            data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350"
                                            data-lightbox="gallery-item"><i
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/20.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/21.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/22.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/23.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/24.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/25.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/26.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/27.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/28.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6  ">
                            <div class="position-relative">
                                <img class="d-block w-100" src="{{asset('/assets/img/gallery/collegegallery/physiotherapy/infrastructure/1.jpg')}}"
                                    alt="Gallery Thumb 2">
                                <div class="bg-overlay">
                                    <div class="bg-overlay-content dark justify-content-end align-items-end"
                                        data-hover-animate="fadeIn">
