  ...
  <div class="panel">
    ...
    <div class="row gutter-30 col-mb-5">
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional�s/pwd_facilities/disabled_friendly_washroom1.jpeg" alt="" style="height: 230px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional�s/pwd_facilities/disabled_friendly_washroom2.jpeg" alt="" style="height: 230px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">PwD Friendly Washrooms Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/disabled_friendly_washroom3.jpeg" alt="" style="height: 230px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">PwD Friendly Washrooms Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
  ...
  <div class="panel">
    ...
    <div class="row gutter-30 col-mb-5">
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s1.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s2.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s3.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s4.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s5.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s6.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s7.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s8.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s9.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s10.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s11.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s12.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-4 col-md-4">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/signage/s13.jpg" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">SignAge for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
  ...
  <div class="panel">
    ...
    <div class="row gutter-30 col-mb-5">
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/Screenshot126.png" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
      ...
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/Screenshot_127.png" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">Assistive technology and facilities at tmu portal for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/Screenshot128.png" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">Assistive technology and facilities at tmu portal for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/Screenshot129.png" alt="" style="height: 300px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">Assistive technology and facilities at tmu portal for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
  ...
  <div class="panel">
    ...
    <div class="row gutter-30 col-mb-5">
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/pwd_assistance1.jpeg" alt="" style="height: 400px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">Assistive technology and facilities at tmu portal for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
      ...
      <div class="col-sm-6 col-md-6">
        <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
          <div class="team-image">
            <img src="https://www.tmu.ac.in/img/facilities/institutional_values/pwd_facilities/pwd_assistance2.jpeg" alt="" style="height: 380px;">
          </div>
          <div class="team-desc p-2">
            <div class="team-title pt-0">
              <h4 class="fs-14">Assistive technology and facilities at tmu portal for Pwd Persons</h4><span class="fst-normal fs-12"><i class="fa-solid fa-location-dot"></i>
