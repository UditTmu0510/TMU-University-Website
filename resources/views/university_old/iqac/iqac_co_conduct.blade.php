...
<div class="col-12 col-md-9 col-lg-9 mt-3 mt-sm-0 pt-5">
  <div class="row mx-0">
    <h1 class="tmu-text-primary tmu-page-heading"><span> Code of Conduct </span><span> for Employee</span></h1>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <tr>
            ...
            <td class="centered-icon text-center"><a href="https://www.tmu.ac.in/pdf/employee_code_of_conduct.pdf"><i class="fa-solid fa-file-pdf"></i></a></td>
          </tr>
      </table>
    </div>
    <hr class="horizontal-line">
