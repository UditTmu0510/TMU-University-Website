                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="entry event col-md-4 col-sm-4">
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-meta mb-1">
                                        <ul>
                                            <li><span class="badge bg-warning text-dark py-1 px-2"><i class="uil-calendar-alt"></i>January
                                    ...
                                    <div class="entry-content mt-0">
                                        <p>In a momentous event organized under the auspices of the Center for Jain
                                            Studies, a National Conference unfolded in TMIMT[...]</p>
                                ...
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-content mt-0">
                                        <p>Teerthanker Mahaveer University, the best private university in UP, has taken
                                            a significant leap forward in the[...]</p>
                            ...
                            <div class="entry event col-md-4 col-sm-4">
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-meta mb-1">
                                        <ul>
                                            <li><span class="badge bg-warning text-dark py-1 px-2"><i class="uil-calendar-alt"></i>May 31<sup>st</sup>,2023</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="entry-title title-sm">
                                    ...
                                    <div class="entry-content mt-0">
                                        <p>May 31, 2023, On World No Tobacco Day, <a href="https://www.tmu.ac.in/college-of-nursing">Teerthanker Mahaveer
                                                College of Nursing</a> organised a National Seminar on Innovative
                                            Strategies on Tobacco[...]</p>
                            ...
                            <div class="entry event col-md-4 col-sm-4">
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-meta mb-1">
                                        <ul>
                                            <li><span class="badge bg-warning text-dark py-1 px-2"><i class="uil-calendar-alt"></i>May 20<sup>th</sup>,2023</a></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="entry-title title-sm">
                                        <h2>National Conference At TMU Amending the Quality of Health in Palliative Care
                                            Nursing</h2>
                                    </div>
                                    <div class="entry-content mt-0">
                                        <p>Teerthanker Mahaveer University recently organised the National Conference on
                                            Advancing Healthcare through Informatics & Technology. The[...]</p>
                                ...
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-content mt-0">
                                        <p>Teerthanker Mahaveer University recently hosted a workshop on Vedic
                                            Mathematics on 11 February 2023 for enthusiastic students of different
                                            colleges[...]</p>
                            ...
                            <div class="entry event col-md-4 col-sm-4">
                                <div class="grid-inner row g-0 p-4 bg-transparent shadow-sm h-shadow all-ts h-translatey-sm card border">
                                    ...
                                    <div class="entry-title title-sm">
                                        <h2>Usage of Satellite Remote Sensing in Agriculture, Weather, Urban and Rural
                                            Planning</h2>
                                    </div>
                                    <div class="entry-content mt-0">
