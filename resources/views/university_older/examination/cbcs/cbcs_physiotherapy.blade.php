...
<div class="main-content">
    <div class="container d-none d-sm-block">
        <div style="text-align:center">
            ...
            <iframe src="{{asset('assets/pdf/cbcs/cbcs_physiotherapy.pdf')}}" frameborder="0" height="800px" width="100%"></iframe>
        </div>
    </div>
    <div class="container d-block d-sm-none mb-3">
        <div style="text-align:center">
            ...
            <a href="{{asset('assets/pdf/cbcs/cbcs_physiotherapy.pdf')}}" class="tmu-btn btn-4" download>Download PDF</a>
        </div>
    </div>
</div>
</div>
