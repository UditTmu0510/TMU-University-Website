        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 text-justify">
                <p class="mb-3 fw-bold px-5 py-3 fs-14">At TMU University, we value and
                    ...
                    team is here to provide personalized support. Our mission is to ensure that you
                    ...
                    <div class="col-lg-7 d-flex flex-column justify-content-center p-4 ps-4 pe-4">
                        <div class="">
                            <h2 class="tmu-text-primary mb-1"><span>Benefits of the </span><span> education
                                    loan</span></h2>
                            <p>The loan covers all courses offered by TMU and is processed quickly for applicants.
                                The Punjab National Bank (PNB) branch located on the TMU campus can sanction the loan, regardless of the student's location. For example, a student
                                applying to Punjab National Bank branch, located at TMU Campus, Moradabad (Uttar Pradesh) but staying
