                ...
                <div class="container">
                    ...
                    <div class="container">
                        <p class="text-justify mb-2 mt-0">The Training and Placement Cell at Teerthanker Mahaveer College of Nursing serves as a platform where students, reputed multinational corporate hospitals, government and non-governmental organisations, and the private sector come together to explore employment opportunities.</p>
                                <p class="text-justify mb-2 mt-1">The Placement Cell act as an interface between the healthcare industry and the students, primarily enabling students to select from various career options. Many top-rated corporate hospitals and non-governmental organisations have visited the campus, helping students achieve excellent placements. The Placement Cell works round the year towards generating placement, training, internship & hospital visit opportunities for the students.</p>
                                <p class="text-justify mb-2 mt-1">The Training and Placement Cell organises on-campus and off-campus recruitment and pre-placement training programmes through aptitude tests, group discussions, interviews, presentations, and clinical skills training. To achieve 100% employment for our students and to assist them in securing the best available job opportunities, the Placement Cell follows a two-fold approach:</p>
                                ...
                                <ul class="m-ol-list ps-5 mt-0">
                                    ...
                                    <li>To organize campus recruitment for the students with industries and various organizations of repute from all over India.</li>
                                    <li>To prepare students for campus recruitment by arranging training in Aptitude tests, group discussions, preparing for Technical and HR interviews through professional trainers.</li>
                                ...
                                <ul class="m-ol-list ps-5 mt-0">   
                                    ...
                                    <li>A pre-placement talk is arranged on the assigned date before starting the recruitment process.</li>
