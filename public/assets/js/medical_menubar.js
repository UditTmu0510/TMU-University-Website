...
let path = "https://test.tmuhospital.com/assets/json/medical_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/medical_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/medical_menubarData.json";
    }
