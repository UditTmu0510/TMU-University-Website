let path = "https://test.tmuhospital.com/assets/json/education_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/education_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/education_menubarData.json";
    }
