let path = "https://test.tmuhospital.com/assets/json/ccsit_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/ccsit_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/ccsit_menubarData.json";
    }
