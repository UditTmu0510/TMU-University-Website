let path = "https://test.tmuhospital.com/assets/json/law_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/law_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/law_menubarData.json";
    }
