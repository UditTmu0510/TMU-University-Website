let path = "https://test.tmuhospital.com/assets/json/dental_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/dental_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/dental_menubarData.json";
    }
