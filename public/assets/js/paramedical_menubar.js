let path = "https://test.tmuhospital.com/assets/json/paramedical_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/paramedical_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/paramedical_menubarData.json";
    }
