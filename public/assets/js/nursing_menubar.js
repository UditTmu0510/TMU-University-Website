let path = "https://test.tmuhospital.com/assets/json/nursing_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/nursing_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/nursing_menubarData.json";
    }
