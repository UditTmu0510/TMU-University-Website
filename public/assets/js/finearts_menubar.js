let path = "https://test.tmuhospital.com/assets/json/finearts_menubarData.json";
...
try {
    ...
    {
        path = "http://"+domainName + ":8000"+"/assets/json/finearts_menubarData.json";
       
    }
    else{
        path = "https://"+domainName+"/assets/json/finearts_menubarData.json";
    }
